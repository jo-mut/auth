...
return backend.mailtrap.emails.send_verification_email("johnmutuku628@gmail.com",verification_token);
});
backend.controllers.auth_controllers.handle_sign_up = (function backend$controllers$auth_controllers$handle_sign_up(res,p__12156){
var map__12157 = p__12156;
var map__12157__$1 = cljs.core.__destructure_map(map__12157);
var email = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12157__$1,new cljs.core.Keyword(null,"email","email",1415816706));
var password = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12157__$1,new cljs.core.Keyword(null,"password","password",417022471));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12157__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
var email = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12158__$1,new cljs.core.Keyword(null,"email","email",1415816706));
var password = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12158__$1,new cljs.core.Keyword(null,"password","password",417022471));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12158__$1,new cljs.core.Keyword(null,"name","name",1843675177));
