...
backend.mailtrap.core.mailtrap_client = (function backend$mailtrap$core$mailtrap_client(){
return (new shadow.js.shim.module$mailtrap.MailtrapClient(({"token": backend.mailtrap.core.TOKEN})));
});
