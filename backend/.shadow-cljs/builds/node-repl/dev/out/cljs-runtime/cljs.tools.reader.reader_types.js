...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_14023 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_14023(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_14026 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_14026(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_14028 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_14028(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_14041 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_14041(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_14044 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_14044(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_14048 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_14048(reader);
}
});
...
var G__14105 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__14106 = s.append(c);
c = G__14105;
s = G__14106;
continue;
}
