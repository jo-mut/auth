...
var G__12527 = (i__5727__auto___12524 + (1));
i__5727__auto___12524 = G__12527;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq12451){
...
return cljs.core.some((function (p1__12487_SHARP_){
return (p1__12487_SHARP_ === object);
}),history__$1);
});
