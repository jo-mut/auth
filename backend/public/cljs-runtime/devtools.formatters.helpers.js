...
var G__13254 = devtools.prefs.pref(v);
v = G__13254;
continue;
} else {
return v;
...
}catch (e13198){var _e__11901__auto__ = e13198;
return false;
}})();
...
}catch (e13200){var _e__11901__auto__ = e13200;
return false;
}})();
...
}catch (e13202){var _e__11901__auto__ = e13202;
return false;
}}
}
});
...
var vec__13211 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13211,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13211,(1),null);
...
return cljs.core.some((function (p1__13228_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__13228_SHARP_);
}),template);
});
