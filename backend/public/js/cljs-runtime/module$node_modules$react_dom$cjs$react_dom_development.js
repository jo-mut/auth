shadow$provide.module$node_modules$react_dom$cjs$react_dom_development = function(global, require, module, exports) {
  (function() {
    ...
    function printWarning(level, format, args) {
      if (!(0 < args.length && "string" === typeof args[args.length - 1] && 0 === args[args.length - 1].indexOf("\n    in"))) {
        var stack = ReactSharedInternals.ReactDebugCurrentFrame.getStackAddendum();
        "" !== stack && (format += "%s", args = args.concat([stack]));
      }
      stack = args.map(function(item) {
        return "" + item;
      });
      stack.unshift("Warning: " + format);
      Function.prototype.apply.call(console[level], console, stack);
      try {
        ...
        for (var pluginName in namesToPlugins) {
          ...
          if (!plugins[pluginIndex]) {
            ...
            for (var eventName in pluginIndex) {
              ...
              var dispatchConfig = pluginIndex[eventName], pluginModule$jscomp$0 = pluginModule, eventName$jscomp$0 = eventName;
              if (eventNameDispatchConfigs.hasOwnProperty(eventName$jscomp$0)) {
                throw Error("EventPluginRegistry: More than one plugin attempted to publish the same event name, `" + eventName$jscomp$0 + "`.");
              }
              ...
              if (phasedRegistrationNames) {
                ...
                dispatchConfig.registrationName ? (publishRegistrationName(dispatchConfig.registrationName, pluginModule$jscomp$0, eventName$jscomp$0), JSCompiler_inline_result = !0) : JSCompiler_inline_result = !1;
              }
    ...
    function publishRegistrationName(registrationName, pluginModule, eventName) {
      ...
      pluginModule = registrationName.toLowerCase();
      possibleRegistrationNames[pluginModule] = registrationName;
      "onDoubleClick" === registrationName && (possibleRegistrationNames.ondblclick = registrationName);
    }
    function injectEventPluginsByName(injectedNamesToPlugins) {
      var isOrderingDirty = !1, pluginName;
        ...
        a: {
          switch(workInProgress.tag) {
            ...
            case 9:
              ...
              break a;
            default:
              JSCompiler_inline_result = workInProgress._debugOwner;
              var source = workInProgress._debugSource, name = getComponentName(workInProgress.type), ownerName = null;
              JSCompiler_inline_result && (ownerName = getComponentName(JSCompiler_inline_result.type));
              JSCompiler_inline_result = name;
              name = "";
              source ? (name = source.fileName, ownerName = name.replace(BEFORE_SLASH_RE, ""), /^index\./.test(ownerName) && (name = name.match(BEFORE_SLASH_RE)) && (name = name[1]) && (ownerName = name.replace(BEFORE_SLASH_RE, "") + "/" + ownerName), name = " (at " + ownerName + ":" + source.lineNumber + ")") : ownerName && (name = " (created by " + ownerName + ")");
              JSCompiler_inline_result = "\n    in " + (JSCompiler_inline_result || "Unknown") + name;
          }
        }
    ...
    function resetCurrentFiber() {
      current = ReactDebugCurrentFrame$1.getCurrentStack = null;
      isRendering = !1;
    }
    ...
    function handleTopLevel(bookKeeping) {
      ...
      for (ancestor = 0; ancestor < bookKeeping.ancestors.length; ancestor++) {
        ...
        var nativeEvent = bookKeeping.nativeEvent, eventSystemFlags = bookKeeping.eventSystemFlags;
    ...
    function createQueuedReplayableEvent(blockedOn, topLevelType, eventSystemFlags, container, nativeEvent) {
      return {blockedOn, topLevelType, eventSystemFlags:eventSystemFlags | 32, nativeEvent, container};
    }
    ...
    function accumulateOrCreateContinuousQueuedReplayableEvent(existingQueuedEvent, blockedOn, topLevelType, eventSystemFlags, container, nativeEvent) {
      if (null === existingQueuedEvent || existingQueuedEvent.nativeEvent !== nativeEvent) {
        return existingQueuedEvent = createQueuedReplayableEvent(blockedOn, topLevelType, eventSystemFlags, container, nativeEvent), null !== blockedOn && (blockedOn = getInstanceFromNode$1(blockedOn), null !== blockedOn && attemptContinuousHydration(blockedOn)), existingQueuedEvent;
      }
    ...
    function processSimpleEventPluginPairsByPriority(eventTypes, priority) {
      for (var i = 0; i < eventTypes.length; i += 2) {
        var topEvent = eventTypes[i], event = eventTypes[i + 1], onEvent = "on" + (event[0].toUpperCase() + event.slice(1));
        onEvent = {phasedRegistrationNames:{bubbled:onEvent, captured:onEvent + "Capture"}, dependencies:[topEvent], eventPriority:priority};
    ...
    function dispatchEvent(topLevelType, eventSystemFlags, container, nativeEvent) {
      if (_enabled) {
        if (0 < queuedDiscreteEvents.length && -1 < discreteReplayableEvents.indexOf(topLevelType)) {
          topLevelType = createQueuedReplayableEvent(null, topLevelType, eventSystemFlags, container, nativeEvent), queuedDiscreteEvents.push(topLevelType);
        } else {
          var blockedOn = attemptToDispatchEvent(topLevelType, eventSystemFlags, container, nativeEvent);
          if (null === blockedOn) {
            clearIfContinuousEvent(topLevelType, nativeEvent);
          } else {
            if (-1 < discreteReplayableEvents.indexOf(topLevelType)) {
              topLevelType = createQueuedReplayableEvent(blockedOn, topLevelType, eventSystemFlags, container, nativeEvent), queuedDiscreteEvents.push(topLevelType);
            } else {
      ...
      if (null !== container) {
        ...
        if (null === nearestMounted) {
          ...
          if (13 === tag) {
            ...
            nearestMounted !== container && (container = null);
          }
        }
      }
    ...
    function assertValidProps(tag, props) {
      if (props) {
        ...
        if (null != props.style && "object" !== typeof props.style) {
          throw Error("The `style` prop expects a mapping from style properties to values, not a string. For example, style\x3d{{marginRight: spacing + 'em'}} when using JSX." + ReactDebugCurrentFrame$3.getStackAddendum());
        }
      }
    }
    ...
    function warnInvalidARIAProps(type, props) {
      ...
      1 === invalidProps.length ? error("Invalid aria prop %s on \x3c%s\x3e tag. For details, see https://fb.me/invalid-aria-prop", props, type) : 1 < invalidProps.length && error("Invalid aria props %s on \x3c%s\x3e tag. For details, see https://fb.me/invalid-aria-prop", props, type);
    }
    function ensureListeningTo(rootContainerElement, registrationName) {
      ...
      for (var i = 0; i < registrationName.length; i++) {
        legacyListenToTopLevelEvent(registrationName[i], rootContainerElement, listenerMap);
      }
    }
    function noop() {
    }
    ...
    function accumulateDirectionalDispatches(inst, phase, event) {
      ...
      if (phase = getListener(inst, event.dispatchConfig.phasedRegistrationNames[phase])) {
        event._dispatchListeners = accumulateInto(event._dispatchListeners, phase), event._dispatchInstances = accumulateInto(event._dispatchInstances, inst);
      }
    }
    ...
    function SyntheticEvent(dispatchConfig, targetInst, nativeEvent, nativeEventTarget) {
      ...
      for (var propName in dispatchConfig) {
        dispatchConfig.hasOwnProperty(propName) && (delete this[propName], (targetInst = dispatchConfig[propName]) ? this[propName] = targetInst(nativeEvent) : "target" === propName ? this.target = nativeEventTarget : this[propName] = nativeEvent[propName]);
      }
    ...
    function getPooledWarningPropertyDefinition(propName, getVal) {
      ...
      return {configurable:!0, set:function(val) {
    ...
    function getFallbackBeforeInputChars(topLevelType, nativeEvent) {
      if (isComposing) {
        return "compositionend" === topLevelType || !canUseCompositionEvent && isFallbackCompositionEnd(topLevelType, nativeEvent) ? (topLevelType = getData(), fallbackText = startText = root = null, isComposing = !1, topLevelType) : null;
      }
      switch(topLevelType) {
        case "paste":
          return null;
    ...
    function handlePropertyChange(nativeEvent) {
      if ("value" === nativeEvent.propertyName && getInstIfValueChanged(activeElementInst)) {
        if (nativeEvent = createAndAccumulateChangeEvent(activeElementInst, nativeEvent, getEventTarget(nativeEvent)), isInsideEventHandler) {
    ...
    function constructSelectEvent(nativeEvent, nativeEventTarget) {
      ...
      doc = activeElement$1;
      "selectionStart" in doc && hasSelectionCapabilities(doc) ? doc = {start:doc.selectionStart, end:doc.selectionEnd} : (doc = (doc.ownerDocument && doc.ownerDocument.defaultView || window).getSelection(), doc = {anchorNode:doc.anchorNode, anchorOffset:doc.anchorOffset, focusNode:doc.focusNode, focusOffset:doc.focusOffset});
    ...
    function startPhaseTimer(fiber, phase) {
      supportsUserTiming && (null !== currentPhase && null !== currentPhaseFiber && clearFiberMark(currentPhaseFiber, currentPhase), currentPhase = currentPhaseFiber = null, hasScheduledUpdateInCurrentPhase = !1, beginFiberMark(fiber, phase) && (currentPhaseFiber = fiber, currentPhase = phase));
    }
    function stopPhaseTimer() {
      supportsUserTiming && (null !== currentPhase && null !== currentPhaseFiber && endFiberMark(currentPhaseFiber, currentPhase, hasScheduledUpdateInCurrentPhase ? "Scheduled a cascading update" : null), currentPhaseFiber = currentPhase = null);
    }
    function startWorkLoopTimer(nextUnitOfWork) {
      currentFiber = nextUnitOfWork;
      supportsUserTiming && (commitCountInCurrentWorkLoop = 0, beginMark("(React Tree Reconciliation)"), null !== currentFiber && resumeTimersRecursively(currentFiber));
    }
    function stopWorkLoopTimer(interruptedBy, didCompleteRoot) {
      if (supportsUserTiming) {
        var warning = null;
        null !== interruptedBy ? warning = 3 === interruptedBy.tag ? "A top-level update interrupted the previous render" : "An update to " + (getComponentName(interruptedBy.type) || "Unknown") + " interrupted the previous render" : 1 < commitCountInCurrentWorkLoop && (warning = "There were cascading updates");
        commitCountInCurrentWorkLoop = 0;
        interruptedBy = didCompleteRoot ? "(React Tree Reconciliation: Completed Root)" : "(React Tree Reconciliation: Yielded)";
        for (didCompleteRoot = currentFiber; didCompleteRoot;) {
          didCompleteRoot._debugIsCurrentlyTiming && endFiberMark(didCompleteRoot, null, null), didCompleteRoot = didCompleteRoot.return;
        }
    ...
    function getMaskedContext(workInProgress, unmaskedContext) {
      ...
      checkPropTypes(contextTypes, context, "context", type, getCurrentFiberStackInDev);
    ...
    function processChildContext(fiber, type, parentContext) {
      ...
      if ("function" !== typeof instance.getChildContext) {
        return childContextTypes = getComponentName(type) || "Unknown", warnedAboutMissingGetChildContext[childContextTypes] || (warnedAboutMissingGetChildContext[childContextTypes] = !0, error("%s.childContextTypes is specified but there is no getChildContext() method on the instance. You can either define getChildContext() on %s or remove childContextTypes from it.", childContextTypes, childContextTypes)), parentContext;
      }
      ...
      type = getComponentName(type) || "Unknown";
      checkPropTypes(childContextTypes, fiber, "child context", type, getCurrentFiberStackInDev);
      return _assign({}, parentContext, {}, fiber);
    }
    ...
    function inferPriorityFromExpirationTime(currentTime, expirationTime) {
      ...
      return 0 >= currentTime ? 99 : 600 >= currentTime ? 98 : 5250 >= currentTime ? 97 : 95;
    }
    ...
    function scheduleFibersWithFamiliesRecursively(fiber, updatedFamilies, staleFamilies) {
      ...
      (needsRemount || type) && scheduleWork(fiber, 1073741823);
    ...
    function scheduleWorkOnParentPath(parent, renderExpirationTime) {
      for (; null !== parent;) {
        ...
        if (parent.childExpirationTime < renderExpirationTime) {
          parent.childExpirationTime = renderExpirationTime, null !== alternate && alternate.childExpirationTime < renderExpirationTime && (alternate.childExpirationTime = renderExpirationTime);
        } else if (null !== alternate && alternate.childExpirationTime < renderExpirationTime) {
    ...
    function readContext(context, observedBits) {
      ...
      if (lastContextWithAllBitsObserved !== context && !1 !== observedBits && 0 !== observedBits) {
        ...
        if (null === lastContextDependency) {
          ...
          currentlyRenderingFiber.dependencies = {expirationTime:0, firstContext:observedBits, responders:null};
        } else {
    ...
    function initializeUpdateQueue(fiber) {
      fiber.updateQueue = {baseState:fiber.memoizedState, baseQueue:null, shared:{pending:null}, effects:null};
    }
    function cloneUpdateQueue(current, workInProgress) {
      current = current.updateQueue;
      workInProgress.updateQueue === current && (workInProgress.updateQueue = {baseState:current.baseState, baseQueue:current.baseQueue, shared:current.shared, effects:current.effects});
    }
    function createUpdate(expirationTime, suspenseConfig) {
      expirationTime = {expirationTime, suspenseConfig, tag:UpdateState, payload:null, callback:null, next:null};
      expirationTime.next = expirationTime;
      expirationTime.priority = getCurrentPriorityLevel();
    ...
    function processUpdateQueue(workInProgress, props, instance$jscomp$0, renderExpirationTime) {
      var queue = workInProgress.updateQueue;
      hasForceUpdate = !1;
      currentlyProcessingQueue = queue.shared;
      var baseQueue = queue.baseQueue, pendingQueue = queue.shared.pending;
      if (null !== pendingQueue) {
        ...
        baseFirst = workInProgress.alternate;
        null !== baseFirst && (baseFirst = baseFirst.updateQueue, null !== baseFirst && (baseFirst.baseQueue = pendingQueue));
      }
      if (null !== baseQueue) {
        baseFirst = baseQueue.next;
        var newState = queue.baseState, newExpirationTime = 0, newBaseState = null, newBaseQueueFirst = null, newBaseQueueLast = null;
        if (null !== baseFirst) {
          ...
          do {
            ...
            if (pendingQueue < renderExpirationTime) {
              ...
              null !== newBaseQueueLast && (newBaseQueueLast = newBaseQueueLast.next = {expirationTime:1073741823, suspenseConfig:update.suspenseConfig, tag:update.tag, payload:update.payload, callback:update.callback, next:null});
              markRenderEventTimeAndConfig(pendingQueue, update.suspenseConfig);
              a: {
                pendingQueue = workInProgress;
                var update$jscomp$0 = update;
                clone = props;
                var instance = instance$jscomp$0;
                switch(update$jscomp$0.tag) {
                  case 1:
                    update$jscomp$0 = update$jscomp$0.payload;
                    if ("function" === typeof update$jscomp$0) {
                      isDisallowedContextReadInDEV = !0;
                      pendingQueue.mode & 1 && update$jscomp$0.call(instance, newState, clone);
                      pendingQueue = update$jscomp$0.call(instance, newState, clone);
                      isDisallowedContextReadInDEV = !1;
                      newState = pendingQueue;
                      break a;
                    }
                    newState = update$jscomp$0;
                    break a;
                  case CaptureUpdate:
                    pendingQueue.effectTag = pendingQueue.effectTag & -4097 | 64;
                  case UpdateState:
                    update$jscomp$0 = update$jscomp$0.payload;
                    "function" === typeof update$jscomp$0 ? (isDisallowedContextReadInDEV = !0, pendingQueue.mode & 1 && update$jscomp$0.call(instance, newState, clone), pendingQueue = update$jscomp$0.call(instance, newState, clone), isDisallowedContextReadInDEV = !1) : pendingQueue = update$jscomp$0;
              ...
              null !== update.callback && (workInProgress.effectTag |= 32, pendingQueue = queue.effects, null === pendingQueue ? queue.effects = [update] : pendingQueue.push(update));
            }
            update = update.next;
            if (null === update || update === baseFirst) {
              if (pendingQueue = queue.shared.pending, null === pendingQueue) {
                ...
                update = baseQueue.next = pendingQueue.next, pendingQueue.next = baseFirst, queue.baseQueue = baseQueue = pendingQueue, queue.shared.pending = null;
              }
            }
          } while (1);
        }
    ...
    function applyDerivedStateFromProps(workInProgress, ctor, getDerivedStateFromProps, nextProps) {
      ...
      workInProgress.mode & 1 && getDerivedStateFromProps(nextProps, prevState);
      ...
      0 === workInProgress.expirationTime && (workInProgress.updateQueue.baseState = ctor);
    }
    function checkShouldComponentUpdate(workInProgress, ctor, oldProps, newProps, oldState, newState, nextContext) {
      ...
      workInProgress) : ctor.prototype && ctor.prototype.isPureReactComponent ? !shallowEqual(oldProps, newProps) || !shallowEqual(oldState, newState) : !0;
    }
    function constructClassInstance(workInProgress, ctor, props) {
      ...
      workInProgress.mode & 1 && new ctor(props, context);
    ...
    function mountClassInstance(workInProgress, ctor, newProps, renderExpirationTime) {
      ...
      ctor !== instance.state && (error("%s.componentWillMount(): Assigning directly to this.state is deprecated (except inside a component's constructor). Use setState instead.", getComponentName(workInProgress.type) || "Component"), classComponentUpdater.enqueueReplaceState(instance, instance.state, null)), processUpdateQueue(workInProgress, newProps, instance, renderExpirationTime), instance.state = workInProgress.memoizedState);
    ...
    function coerceRef(returnFiber, current, element) {
      ...
      if (null !== mixedRef && "function" !== typeof mixedRef && "object" !== typeof mixedRef) {
        if (returnFiber.mode & 1 && (!element._owner || !element._self || element._owner.stateNode === element._self)) {
          var componentName = getComponentName(returnFiber.type) || "Component";
          didWarnAboutStringRefs[componentName] || (error('A string ref, "%s", has been found within a strict mode tree. String refs are a source of potential bugs and should be avoided. We recommend using useRef() or createRef() instead. Learn more about using refs safely here: https://fb.me/react-strict-mode-string-ref%s', mixedRef, getStackByFiberInDevAndProd(returnFiber)), didWarnAboutStringRefs[componentName] = !0);
        }
        if (element._owner) {
    ...
    function throwOnInvalidObjectType(returnFiber, newChild) {
      if ("textarea" !== returnFiber.type) {
        throw returnFiber = " If you meant to render a collection of children, use an array instead." + getCurrentFiberStackInDev(), Error("Objects are not valid as a React child (found: " + ("[object Object]" === Object.prototype.toString.call(newChild) ? "object with keys {" + Object.keys(newChild).join(", ") + "}" : newChild) + ")." + returnFiber);
      }
    }
    function warnOnFunctionType() {
      var currentComponentErrorInfo = "Functions are not valid as a React child. This may happen if you return a Component instead of \x3cComponent /\x3e from render. Or maybe you meant to call this function rather than return it." + getCurrentFiberStackInDev();
    ...
    function ChildReconciler(shouldTrackSideEffects) {
      ...
      function placeChild(newFiber, lastPlacedIndex, newIndex) {
        ...
        if (null !== newIndex) {
          return newIndex = newIndex.index, newIndex < lastPlacedIndex ? (newFiber.effectTag = 2, lastPlacedIndex) : newIndex;
        }
      ...
      function updateTextNode(returnFiber, current, textContent, expirationTime) {
        if (null === current || 6 !== current.tag) {
          return current = createFiberFromText(textContent, returnFiber.mode, expirationTime), current.return = returnFiber, current;
        }
      ...
      function updateElement(returnFiber, current, element, expirationTime) {
        if (null !== current && (current.elementType === element.type || isCompatibleFamilyForHotReloading(current, element))) {
          return expirationTime = useFiber(current, element.props), expirationTime.ref = coerceRef(returnFiber, current, element), expirationTime.return = returnFiber, expirationTime._debugSource = element._source, expirationTime._debugOwner = element._owner, expirationTime;
        }
      ...
      function updatePortal(returnFiber, current, portal, expirationTime) {
        if (null === current || 4 !== current.tag || current.stateNode.containerInfo !== portal.containerInfo || current.stateNode.implementation !== portal.implementation) {
          return current = createFiberFromPortal(portal, returnFiber.mode, expirationTime), current.return = returnFiber, current;
        }
      ...
      function updateFragment(returnFiber, current, fragment, expirationTime, key) {
        if (null === current || 7 !== current.tag) {
          return current = createFiberFromFragment(fragment, returnFiber.mode, expirationTime, key), current.return = returnFiber, current;
        }
      ...
      function createChild(returnFiber, newChild, expirationTime) {
        if ("string" === typeof newChild || "number" === typeof newChild) {
          return newChild = createFiberFromText("" + newChild, returnFiber.mode, expirationTime), newChild.return = returnFiber, newChild;
        }
        if ("object" === typeof newChild && null !== newChild) {
          ...
          if (isArray$1(newChild) || getIteratorFn(newChild)) {
            return newChild = createFiberFromFragment(newChild, returnFiber.mode, expirationTime, null), newChild.return = returnFiber, newChild;
          }
      ...
      function updateFromMap(existingChildren, returnFiber, newIdx, newChild, expirationTime) {
        if ("string" === typeof newChild || "number" === typeof newChild) {
          return existingChildren = existingChildren.get(newIdx) || null, updateTextNode(returnFiber, existingChildren, "" + newChild, expirationTime);
        }
        if ("object" === typeof newChild && null !== newChild) {
          switch(newChild.$$typeof) {
            case REACT_ELEMENT_TYPE:
          ...
          if (isArray$1(newChild) || getIteratorFn(newChild)) {
            return existingChildren = existingChildren.get(newIdx) || null, updateFragment(returnFiber, existingChildren, newChild, expirationTime, null);
          }
          throwOnInvalidObjectType(returnFiber, newChild);
        }
        "function" === typeof newChild && warnOnFunctionType();
      ...
      function warnOnInvalidKey(child, knownKeys) {
        ...
        switch(child.$$typeof) {
          case REACT_ELEMENT_TYPE:
          case REACT_PORTAL_TYPE:
            warnForMissingKey(child), child = child.key, "string" === typeof child && (null === knownKeys ? (knownKeys = new Set(), knownKeys.add(child)) : knownKeys.has(child) ? error("Encountered two children with the same key, `%s`. Keys should be unique so that components maintain their identity across updates. Non-unique keys may cause children to be duplicated and/or omitted — the behavior is unsupported and could change in a future version.", child) : knownKeys.add(child));
        }
        return knownKeys;
      }
      function reconcileChildrenArray(returnFiber, currentFirstChild, newChildren, expirationTime) {
        ...
        if (null === oldFiber) {
          for (; newIdx < newChildren.length; newIdx++) {
            oldFiber = createChild(returnFiber, newChildren[newIdx], expirationTime), null !== oldFiber && (currentFirstChild = placeChild(oldFiber, currentFirstChild, newIdx), null === i ? knownKeys = oldFiber : i.sibling = oldFiber, i = oldFiber);
          }
          return knownKeys;
        }
      ...
      function reconcileChildrenIterator(returnFiber, currentFirstChild, newChildrenIterable, expirationTime) {
        ...
        newChildrenIterable.entries === iteratorFn && (didWarnAboutMaps || error("Using Maps as children is unsupported and will likely yield unexpected results. Convert it to a sequence/iterable of keyed ReactElements instead."), didWarnAboutMaps = !0);
        ...
        for (_step = newChildrenIterable.next(); null !== oldFiber && !_step.done; knownKeys++, _step = newChildrenIterable.next()) {
          ...
          var newFiber = updateSlot(returnFiber, oldFiber, _step.value, expirationTime);
          if (null === newFiber) {
            null === oldFiber && (oldFiber = nextOldFiber);
            break;
          }
        ...
        if (null === oldFiber) {
          for (; !_step.done; knownKeys++, _step = newChildrenIterable.next()) {
            _step = createChild(returnFiber, _step.value, expirationTime), null !== _step && (currentFirstChild = placeChild(_step, currentFirstChild, knownKeys), null === _newChildren ? iteratorFn = _step : _newChildren.sibling = _step, _newChildren = _step);
          }
          return iteratorFn;
        }
    ...
    function renderWithHooks(current, workInProgress, Component, props, secondArg, nextRenderExpirationTime) {
      ...
      ReactCurrentDispatcher.current = null !== current && null !== current.memoizedState ? HooksDispatcherOnUpdateInDEV : null !== hookTypesDev ? HooksDispatcherOnMountWithHookTypesInDEV : HooksDispatcherOnMountInDEV;
    ...
    function mountEffectImpl(fiberEffectTag, hookEffectTag, create, deps) {
      ...
      hook.memoizedState = pushEffect(HasEffect | hookEffectTag, create, void 0, void 0 === deps ? null : deps);
    }
    function updateEffectImpl(fiberEffectTag, hookEffectTag, create, deps) {
      ...
      currentlyRenderingFiber$1.effectTag |= fiberEffectTag;
      hook.memoizedState = pushEffect(HasEffect | hookEffectTag, create, destroy, deps);
    }
    ...
    function dispatchAction(fiber, queue, action, JSCompiler_OptimizeArgumentsArray_p1) {
      ...
      var suspenseConfig = ReactCurrentBatchConfig.suspense;
      JSCompiler_OptimizeArgumentsArray_p1 = computeExpirationForFiber(JSCompiler_OptimizeArgumentsArray_p1, fiber, suspenseConfig);
      suspenseConfig = {expirationTime:JSCompiler_OptimizeArgumentsArray_p1, suspenseConfig, action, eagerReducer:null, eagerState:null, next:null};
      suspenseConfig.priority = getCurrentPriorityLevel();
      ...
      if (fiber === currentlyRenderingFiber$1 || null !== pending && pending === currentlyRenderingFiber$1) {
        didScheduleRenderPhaseUpdate = !0, suspenseConfig.expirationTime = renderExpirationTime, currentlyRenderingFiber$1.expirationTime = renderExpirationTime;
      } else {
        if (0 === fiber.expirationTime && (null === pending || 0 === pending.expirationTime) && (pending = queue.lastRenderedReducer, null !== pending)) {
        ...
        "undefined" !== typeof jest && (warnIfNotScopedWithMatchingAct(fiber), executionContext === NoContext && !1 === IsSomeRendererActing.current && !1 === IsThisRendererActing.current && error("An update to %s inside a test was not wrapped in act(...).\n\nWhen testing, code that causes React state updates should be wrapped into act(...):\n\nact(() \x3d\x3e {\n  /* fire events that update state */\n});\n/* assert on the output */\n\nThis ensures that you're testing the behavior the user would see in the browser. Learn more at https://fb.me/react-wrap-tests-with-act%s", 
        getComponentName(fiber.type), getStackByFiberInDevAndProd(fiber)));
        scheduleWork(fiber, JSCompiler_OptimizeArgumentsArray_p1);
      }
    }
    ...
    function updateForwardRef(current, workInProgress, Component, nextProps, renderExpirationTime) {
      ...
      isRendering = !0;
      var nextChildren = renderWithHooks(current, workInProgress, Component, nextProps, innerPropTypes, renderExpirationTime);
      workInProgress.mode & 1 && null !== workInProgress.memoizedState && (nextChildren = renderWithHooks(current, workInProgress, Component, nextProps, innerPropTypes, renderExpirationTime));
      isRendering = !1;
      if (null !== current && !didReceiveUpdate) {
        return workInProgress.updateQueue = current.updateQueue, workInProgress.effectTag &= -517, current.expirationTime <= renderExpirationTime && (current.expirationTime = 0), bailoutOnAlreadyFinishedWork(current, workInProgress, renderExpirationTime);
      }
    ...
    function updateMemoComponent(current, workInProgress, Component, nextProps, updateExpirationTime, renderExpirationTime) {
      if (null === current) {
        ...
        if ("function" === typeof type && !shouldConstruct(type) && void 0 === type.defaultProps && null === Component.compare && void 0 === Component.defaultProps) {
          return Component = resolveFunctionForHotReloading(type), workInProgress.tag = 15, workInProgress.type = Component, validateFunctionComponentInDev(workInProgress, type), updateSimpleMemoComponent(current, workInProgress, Component, nextProps, updateExpirationTime, renderExpirationTime);
        }
        (current = type.propTypes) && checkPropTypes(current, nextProps, "prop", getComponentName(type), getCurrentFiberStackInDev);
        nextProps = createFiberFromTypeAndProps(Component.type, null, nextProps, null, workInProgress.mode, renderExpirationTime);
      ...
      _innerPropTypes && checkPropTypes(_innerPropTypes, nextProps, "prop", getComponentName(type), getCurrentFiberStackInDev);
      type = current.child;
      if (updateExpirationTime < renderExpirationTime && (updateExpirationTime = type.memoizedProps, Component = Component.compare, Component = null !== Component ? Component : shallowEqual, Component(updateExpirationTime, nextProps) && current.ref === workInProgress.ref)) {
    ...
    function updateSimpleMemoComponent(current, workInProgress, Component, nextProps, updateExpirationTime, renderExpirationTime) {
      if (workInProgress.type !== workInProgress.elementType) {
        ...
        outerMemoType.$$typeof === REACT_LAZY_TYPE && (outerMemoType = 1 === outerMemoType._status ? outerMemoType._result : null);
      ...
      return null !== current && shallowEqual(current.memoizedProps, nextProps) && current.ref === workInProgress.ref && workInProgress.type === current.type && (didReceiveUpdate = !1, updateExpirationTime < renderExpirationTime) ? (workInProgress.expirationTime = current.expirationTime, bailoutOnAlreadyFinishedWork(current, workInProgress, renderExpirationTime)) : updateFunctionComponent(current, workInProgress, Component, nextProps, renderExpirationTime);
    }
    ...
    function updateClassComponent(current, workInProgress, Component, nextProps, renderExpirationTime) {
      ...
      if (null === workInProgress.stateNode) {
        ...
        processUpdateQueue(workInProgress, nextProps, shouldUpdate, renderExpirationTime);
        ...
        "function" !== typeof shouldUpdate.componentWillMount || (startPhaseTimer(workInProgress, "componentWillMount"), "function" === typeof shouldUpdate.componentWillMount && shouldUpdate.componentWillMount(), "function" === typeof shouldUpdate.UNSAFE_componentWillMount && shouldUpdate.UNSAFE_componentWillMount(), stopPhaseTimer()), "function" === typeof shouldUpdate.componentDidMount && (workInProgress.effectTag |= 4)) : ("function" === typeof shouldUpdate.componentDidMount && (workInProgress.effectTag |= 
        4), workInProgress.memoizedProps = nextProps, workInProgress.memoizedState = oldContext), shouldUpdate.props = nextProps, shouldUpdate.state = oldContext, shouldUpdate.context = contextType, shouldUpdate = oldProps) : ("function" === typeof shouldUpdate.componentDidMount && (workInProgress.effectTag |= 4), shouldUpdate = !1);
      } else {
        shouldUpdate = workInProgress.stateNode, cloneUpdateQueue(current, workInProgress), oldProps = workInProgress.memoizedProps, shouldUpdate.props = workInProgress.type === workInProgress.elementType ? oldProps : resolveDefaultProps(workInProgress.type, oldProps), oldContext = shouldUpdate.context, contextType = Component.contextType, "object" === typeof contextType && null !== contextType ? contextType = readContext(contextType) : (contextType = isContextProvider(Component) ? previousContext : 
        contextStackCursor.current, contextType = getMaskedContext(workInProgress, contextType)), getDerivedStateFromProps = Component.getDerivedStateFromProps, (hasNewLifecycles = "function" === typeof getDerivedStateFromProps || "function" === typeof shouldUpdate.getSnapshotBeforeUpdate) || "function" !== typeof shouldUpdate.UNSAFE_componentWillReceiveProps && "function" !== typeof shouldUpdate.componentWillReceiveProps || (oldProps !== nextProps || oldContext !== contextType) && callComponentWillReceiveProps(workInProgress, 
        shouldUpdate, nextProps, contextType), hasForceUpdate = !1, oldContext = workInProgress.memoizedState, shouldUpdate.state = oldContext, processUpdateQueue(workInProgress, nextProps, shouldUpdate, renderExpirationTime), oldState = workInProgress.memoizedState, oldProps !== nextProps || oldContext !== oldState || didPerformWorkStackCursor.current || hasForceUpdate ? ("function" === typeof getDerivedStateFromProps && (applyDerivedStateFromProps(workInProgress, Component, getDerivedStateFromProps, 
        nextProps), oldState = workInProgress.memoizedState), (getDerivedStateFromProps = hasForceUpdate || checkShouldComponentUpdate(workInProgress, Component, oldProps, nextProps, oldContext, oldState, contextType)) ? (hasNewLifecycles || "function" !== typeof shouldUpdate.UNSAFE_componentWillUpdate && "function" !== typeof shouldUpdate.componentWillUpdate || (startPhaseTimer(workInProgress, "componentWillUpdate"), "function" === typeof shouldUpdate.componentWillUpdate && shouldUpdate.componentWillUpdate(nextProps, 
        oldState, contextType), "function" === typeof shouldUpdate.UNSAFE_componentWillUpdate && shouldUpdate.UNSAFE_componentWillUpdate(nextProps, oldState, contextType), stopPhaseTimer()), "function" === typeof shouldUpdate.componentDidUpdate && (workInProgress.effectTag |= 4), "function" === typeof shouldUpdate.getSnapshotBeforeUpdate && (workInProgress.effectTag |= 256)) : ("function" !== typeof shouldUpdate.componentDidUpdate || oldProps === current.memoizedProps && oldContext === current.memoizedState || 
        ...
        current.memoizedProps && oldContext === current.memoizedState || (workInProgress.effectTag |= 4), "function" !== typeof shouldUpdate.getSnapshotBeforeUpdate || oldProps === current.memoizedProps && oldContext === current.memoizedState || (workInProgress.effectTag |= 256), shouldUpdate = !1);
      }
      current = finishClassComponent(current, workInProgress, Component, shouldUpdate, innerPropTypes, renderExpirationTime);
      workInProgress.stateNode.props !== nextProps && (didWarnAboutReassigningProps || error("It looks like %s is reassigning its own `this.props` while rendering. This is not supported and can lead to confusing bugs.", getComponentName(workInProgress.type) || "a component"), didWarnAboutReassigningProps = !0);
      return current;
    }
    function finishClassComponent(current, workInProgress, Component, shouldUpdate, hasContext, renderExpirationTime) {
      ...
      if (!shouldUpdate && !didCaptureError) {
        return hasContext && invalidateContextProvider(workInProgress, Component, !1), bailoutOnAlreadyFinishedWork(current, workInProgress, renderExpirationTime);
      }
      shouldUpdate = workInProgress.stateNode;
      ReactCurrentOwner$1.current = workInProgress;
      if (didCaptureError && "function" !== typeof Component.getDerivedStateFromError) {
        ...
        isRendering = !0, nextChildren = shouldUpdate.render(), workInProgress.mode & 1 && shouldUpdate.render(), isRendering = !1;
      }
      workInProgress.effectTag |= 1;
      null !== current && didCaptureError ? (didCaptureError = nextChildren, workInProgress.child = reconcileChildFibers(workInProgress, current.child, null, renderExpirationTime), workInProgress.child = reconcileChildFibers(workInProgress, null, didCaptureError, renderExpirationTime)) : reconcileChildren(current, workInProgress, nextChildren, renderExpirationTime);
    ...
    function updateSuspenseComponent(current, workInProgress, renderExpirationTime) {
      var mode = workInProgress.mode, nextProps = workInProgress.pendingProps;
      shouldSuspendImpl(workInProgress) && (workInProgress.effectTag |= 64);
      var suspenseContext = suspenseStackCursor.current, nextDidTimeout = !1, JSCompiler_temp;
      (JSCompiler_temp = 0 !== (workInProgress.effectTag & 64)) || (JSCompiler_temp = 0 !== (suspenseContext & ForceSuspenseFallback) && (null === current || null !== current.memoizedState));
      JSCompiler_temp ? (nextDidTimeout = !0, workInProgress.effectTag &= -65) : null !== current && null === current.memoizedState || void 0 === nextProps.fallback || !0 === nextProps.unstable_avoidThisFallback || (suspenseContext |= InvisibleParentSuspenseContext);
      ...
      if (null === current) {
        ...
        if (nextDidTimeout) {
          ...
          if (0 === (workInProgress.mode & 2)) {
            for (current = null !== workInProgress.memoizedState ? workInProgress.child.child : workInProgress.child, nextProps.child = current; null !== current;) {
      ...
      if (null !== current.memoizedState) {
        ...
        if (nextDidTimeout) {
          ...
          renderExpirationTime.return = workInProgress;
          if (0 === (workInProgress.mode & 2) && (nextDidTimeout = null !== workInProgress.memoizedState ? workInProgress.child.child : workInProgress.child, nextDidTimeout !== current.child)) {
            for (renderExpirationTime.child = nextDidTimeout; null !== nextDidTimeout;) {
          ...
          if (workInProgress.mode & 8) {
            ...
            for (current = renderExpirationTime.child; null !== current;) {
              nextDidTimeout += current.treeBaseDuration, current = current.sibling;
            }
      ...
      if (nextDidTimeout) {
        ...
        if (workInProgress.mode & 8) {
          ...
          for (suspenseContext = nextProps.child; null !== suspenseContext;) {
            current += suspenseContext.treeBaseDuration, suspenseContext = suspenseContext.sibling;
          }
    ...
    function updateSuspenseListComponent(current, workInProgress, renderExpirationTime) {
      ...
      if (0 !== (nextProps & ForceSuspenseFallback)) {
        nextProps = nextProps & SubtreeSuspenseContextMask | ForceSuspenseFallback, workInProgress.effectTag |= 64;
      } else {
        if (null !== current && 0 !== (current.effectTag & 64)) {
          a: {
            for (current = workInProgress.child; null !== current;) {
              if (13 === current.tag) {
                null !== current.memoizedState && scheduleWorkOnFiber(current, renderExpirationTime);
    ...
    function beginWork(current, workInProgress, renderExpirationTime) {
      ...
      if (workInProgress._debugNeedsRemount && null !== current) {
        renderExpirationTime = createFiberFromTypeAndProps(workInProgress.type, workInProgress.key, workInProgress.pendingProps, workInProgress._debugOwner || null, workInProgress.mode, workInProgress.expirationTime);
        updateExpirationTime = workInProgress.return;
        if (null === updateExpirationTime) {
          throw Error("Cannot swap the root fiber.");
        }
        current.alternate = null;
        workInProgress.alternate = null;
        renderExpirationTime.index = workInProgress.index;
        renderExpirationTime.sibling = workInProgress.sibling;
        renderExpirationTime.return = workInProgress.return;
        renderExpirationTime.ref = workInProgress.ref;
        if (workInProgress === updateExpirationTime.child) {
          updateExpirationTime.child = renderExpirationTime;
        } else {
          var prevSibling = updateExpirationTime.child;
          if (null === prevSibling) {
          ...
          prevSibling.sibling = renderExpirationTime;
        }
        workInProgress = updateExpirationTime.lastEffect;
        null !== workInProgress ? (workInProgress.nextEffect = current, updateExpirationTime.lastEffect = current) : updateExpirationTime.firstEffect = updateExpirationTime.lastEffect = current;
      ...
      if (null !== current) {
        if (prevSibling = workInProgress.pendingProps, current.memoizedProps !== prevSibling || didPerformWorkStackCursor.current || workInProgress.type !== current.type) {
          didReceiveUpdate = !0;
        } else {
          if (updateExpirationTime < renderExpirationTime) {
            didReceiveUpdate = !1;
            switch(workInProgress.tag) {
              ...
              case 5:
                ...
                if (workInProgress.mode & 4 && 1 !== renderExpirationTime && prevSibling.hidden) {
                  return markSpawnedWork(1), workInProgress.expirationTime = workInProgress.childExpirationTime = 1, null;
                }
                break;
              case 1:
              ...
              case 13:
                if (null !== workInProgress.memoizedState) {
                  ...
                  if (0 !== updateExpirationTime && updateExpirationTime >= renderExpirationTime) {
              ...
              case 19:
                ...
                null !== prevSibling && (prevSibling.rendering = null, prevSibling.tail = null);
      ...
      switch(workInProgress.tag) {
        case 2:
          ...
          if ("object" === typeof prevSibling && null !== prevSibling && "function" === typeof prevSibling.render && void 0 === prevSibling.$$typeof) {
            ...
            workInProgress.memoizedState = null;
            workInProgress.updateQueue = null;
            isContextProvider(updateExpirationTime) ? (context = !0, pushContextProvider(workInProgress)) : context = !1;
            workInProgress.memoizedState = null !== prevSibling.state && void 0 !== prevSibling.state ? prevSibling.state : null;
            initializeUpdateQueue(workInProgress);
            ...
            prevSibling.updater = classComponentUpdater;
            workInProgress.stateNode = prevSibling;
            prevSibling._reactInternalFiber = workInProgress;
            ...
            workInProgress = finishClassComponent(null, workInProgress, updateExpirationTime, !0, context, renderExpirationTime);
          } else {
            workInProgress.tag = 0, workInProgress.mode & 1 && null !== workInProgress.memoizedState && (prevSibling = renderWithHooks(null, workInProgress, updateExpirationTime, current, context, renderExpirationTime)), reconcileChildren(null, workInProgress, prevSibling, renderExpirationTime), validateFunctionComponentInDev(workInProgress, updateExpirationTime), workInProgress = workInProgress.child;
          }
        ...
        case 16:
          a: {
            ...
            if (1 !== context._status) {
              throw context._result;
            }
            current = context._result;
            ...
            switch(context) {
              case 0:
                ...
                workInProgress = updateFunctionComponent(null, workInProgress, current, prevSibling, renderExpirationTime);
                break a;
              case 1:
                workInProgress.type = current = resolveFunctionForHotReloading(current);
                workInProgress = updateClassComponent(null, workInProgress, current, prevSibling, renderExpirationTime);
                break a;
              case 11:
                workInProgress.type = current = resolveForwardRefForHotReloading(current);
                workInProgress = updateForwardRef(null, workInProgress, current, prevSibling, renderExpirationTime);
                break a;
              case 14:
                workInProgress.type !== workInProgress.elementType && (context = current.propTypes) && checkPropTypes(context, prevSibling, "prop", getComponentName(current), getCurrentFiberStackInDev);
                workInProgress = updateMemoComponent(null, workInProgress, current, resolveDefaultProps(current.type, prevSibling), updateExpirationTime, renderExpirationTime);
                break a;
            }
            workInProgress = "";
        ...
        case 3:
          ...
          if (updateExpirationTime === prevSibling) {
            resetHydrationState(), workInProgress = bailoutOnAlreadyFinishedWork(current, workInProgress, renderExpirationTime);
          } else {
            if (prevSibling = workInProgress.stateNode.hydrate) {
              nextHydratableInstance = getNextHydratable(workInProgress.stateNode.containerInfo.firstChild), hydrationParentFiber = workInProgress, prevSibling = isHydrating = !0;
            }
            if (prevSibling) {
              for (renderExpirationTime = mountChildFibers(workInProgress, null, updateExpirationTime, renderExpirationTime), workInProgress.child = renderExpirationTime; renderExpirationTime;) {
                renderExpirationTime.effectTag = renderExpirationTime.effectTag & -3 | 1024, renderExpirationTime = renderExpirationTime.sibling;
              }
            } else {
              reconcileChildren(current, workInProgress, updateExpirationTime, renderExpirationTime), resetHydrationState();
            }
            workInProgress = workInProgress.child;
          }
          return workInProgress;
        case 5:
          return pushHostContext(workInProgress), null === current && tryToClaimNextHydratableInstance(workInProgress), updateExpirationTime = workInProgress.type, prevSibling = workInProgress.pendingProps, context = null !== current ? current.memoizedProps : null, getDerivedStateFromProps = prevSibling.children, shouldSetTextContent(updateExpirationTime, prevSibling) ? getDerivedStateFromProps = null : null !== context && shouldSetTextContent(updateExpirationTime, context) && (workInProgress.effectTag |= 
          16), markRef(current, workInProgress), workInProgress.mode & 4 && 1 !== renderExpirationTime && prevSibling.hidden ? (markSpawnedWork(1), workInProgress.expirationTime = workInProgress.childExpirationTime = 1, workInProgress = null) : (reconcileChildren(current, workInProgress, getDerivedStateFromProps, renderExpirationTime), workInProgress = workInProgress.child), workInProgress;
        case 6:
        ...
        case 11:
          return updateExpirationTime = workInProgress.type, prevSibling = workInProgress.pendingProps, prevSibling = workInProgress.elementType === updateExpirationTime ? prevSibling : resolveDefaultProps(updateExpirationTime, prevSibling), updateForwardRef(current, workInProgress, updateExpirationTime, prevSibling, renderExpirationTime);
        case 7:
        ...
        case 12:
          return workInProgress.effectTag |= 4, reconcileChildren(current, workInProgress, workInProgress.pendingProps.children, renderExpirationTime), workInProgress.child;
        case 10:
          a: {
            updateExpirationTime = workInProgress.type._context;
            prevSibling = workInProgress.pendingProps;
            context = workInProgress.memoizedProps;
            getDerivedStateFromProps = prevSibling.value;
            var providerPropTypes = workInProgress.type.propTypes;
            providerPropTypes && checkPropTypes(providerPropTypes, prevSibling, "prop", "Context.Provider", getCurrentFiberStackInDev);
            pushProvider(workInProgress, getDerivedStateFromProps);
            if (null !== context) {
              if (providerPropTypes = context.value, objectIs(providerPropTypes, getDerivedStateFromProps) ? getDerivedStateFromProps = 0 : (getDerivedStateFromProps = "function" === typeof updateExpirationTime._calculateChangedBits ? updateExpirationTime._calculateChangedBits(providerPropTypes, getDerivedStateFromProps) : 1073741823, (getDerivedStateFromProps & 1073741823) !== getDerivedStateFromProps && error("calculateChangedBits: Expected the return value to be a 31-bit integer. Instead received: %s", 
              getDerivedStateFromProps), getDerivedStateFromProps |= 0), 0 === getDerivedStateFromProps) {
                if (context.children === prevSibling.children && !didPerformWorkStackCursor.current) {
                  workInProgress = bailoutOnAlreadyFinishedWork(current, workInProgress, renderExpirationTime);
                  break a;
                }
              } else {
                for (context = getDerivedStateFromProps, providerPropTypes = workInProgress.child, null !== providerPropTypes && (providerPropTypes.return = workInProgress); null !== providerPropTypes;) {
                  var list = providerPropTypes.dependencies;
                  if (null !== list) {
                    getDerivedStateFromProps = providerPropTypes.child;
                    for (var dependency = list.firstContext; null !== dependency;) {
                      if (dependency.context === updateExpirationTime && 0 !== (dependency.observedBits & context)) {
                        1 === providerPropTypes.tag && (dependency = createUpdate(renderExpirationTime, null), dependency.tag = ForceUpdate, enqueueUpdate(providerPropTypes, dependency));
                        providerPropTypes.expirationTime < renderExpirationTime && (providerPropTypes.expirationTime = renderExpirationTime);
                        ...
                        scheduleWorkOnParentPath(providerPropTypes.return, renderExpirationTime);
                    ...
                    getDerivedStateFromProps = 10 === providerPropTypes.tag ? providerPropTypes.type === workInProgress.type ? null : providerPropTypes.child : providerPropTypes.child;
                  }
                  if (null !== getDerivedStateFromProps) {
                    getDerivedStateFromProps.return = providerPropTypes;
                  } else {
                    for (getDerivedStateFromProps = providerPropTypes; null !== getDerivedStateFromProps;) {
                      if (getDerivedStateFromProps === workInProgress) {
                        getDerivedStateFromProps = null;
                        break;
                      }
                      providerPropTypes = getDerivedStateFromProps.sibling;
                      if (null !== providerPropTypes) {
                        providerPropTypes.return = getDerivedStateFromProps.return;
                        getDerivedStateFromProps = providerPropTypes;
                        break;
                      }
                      getDerivedStateFromProps = getDerivedStateFromProps.return;
                    }
                  }
                  providerPropTypes = getDerivedStateFromProps;
                }
              }
            }
            reconcileChildren(current, workInProgress, prevSibling.children, renderExpirationTime);
            workInProgress = workInProgress.child;
          }
          return workInProgress;
        case 9:
          return prevSibling = workInProgress.type, void 0 === prevSibling._context ? prevSibling === prevSibling.Consumer || hasWarnedAboutUsingContextAsConsumer || (hasWarnedAboutUsingContextAsConsumer = !0, error("Rendering \x3cContext\x3e directly is not supported and will be removed in a future major release. Did you mean to render \x3cContext.Consumer\x3e instead?")) : prevSibling = prevSibling._context, context = workInProgress.pendingProps, updateExpirationTime = context.children, "function" !== 
          typeof updateExpirationTime && error("A context consumer was rendered with multiple children, or a child that isn't a function. A context consumer expects a single child that is a function. If you did pass a function, make sure there is no trailing or leading whitespace around it."), prepareToReadContext(workInProgress, renderExpirationTime), prevSibling = readContext(prevSibling, context.unstable_observedBits), ReactCurrentOwner$1.current = workInProgress, isRendering = !0, updateExpirationTime = 
          updateExpirationTime(prevSibling), isRendering = !1, workInProgress.effectTag |= 1, reconcileChildren(current, workInProgress, updateExpirationTime, renderExpirationTime), workInProgress.child;
        case 14:
          return prevSibling = workInProgress.type, context = resolveDefaultProps(prevSibling, workInProgress.pendingProps), workInProgress.type !== workInProgress.elementType && (getDerivedStateFromProps = prevSibling.propTypes) && checkPropTypes(getDerivedStateFromProps, context, "prop", getComponentName(prevSibling), getCurrentFiberStackInDev), context = resolveDefaultProps(prevSibling.type, context), updateMemoComponent(current, workInProgress, prevSibling, context, updateExpirationTime, renderExpirationTime);
        case 15:
          return updateSimpleMemoComponent(current, workInProgress, workInProgress.type, workInProgress.pendingProps, updateExpirationTime, renderExpirationTime);
        case 17:
          return updateExpirationTime = workInProgress.type, prevSibling = workInProgress.pendingProps, prevSibling = workInProgress.elementType === updateExpirationTime ? prevSibling : resolveDefaultProps(updateExpirationTime, prevSibling), null !== current && (current.alternate = null, workInProgress.alternate = null, workInProgress.effectTag |= 2), workInProgress.tag = 1, isContextProvider(updateExpirationTime) ? (current = !0, pushContextProvider(workInProgress)) : current = !1, prepareToReadContext(workInProgress, 
          renderExpirationTime), constructClassInstance(workInProgress, updateExpirationTime, prevSibling), mountClassInstance(workInProgress, updateExpirationTime, prevSibling, renderExpirationTime), finishClassComponent(null, workInProgress, updateExpirationTime, !0, current, renderExpirationTime);
        case 19:
          return updateSuspenseListComponent(current, workInProgress, renderExpirationTime);
      }
      ...
      switch(workInProgress.tag) {
        ...
        case 5:
          ...
          if (null !== current && null != workInProgress.stateNode) {
            updateHostComponent$1(current, workInProgress, type, newProps, renderExpirationTime), current.ref !== workInProgress.ref && (workInProgress.effectTag |= 128);
          } else {
            if (!newProps) {
              if (null === workInProgress.stateNode) {
            ...
            if (popHydrationState(workInProgress)) {
              ...
              switch(type) {
                ...
                case "audio":
                  for (extraAttributeNames = 0; extraAttributeNames < mediaEventTypes.length; extraAttributeNames++) {
                    trapBubbledEvent(mediaEventTypes[extraAttributeNames], newProps);
                  }
                  break;
                case "source":
              ...
              for (var propKey in props) {
                if (props.hasOwnProperty(propKey)) {
                  if (_i = props[propKey], "children" === propKey) {
                    ...
                    null != _i && ("function" !== typeof _i && warnForInvalidEventListener(propKey, _i), ensureListeningTo(renderExpirationTime, propKey));
                  } else if ("boolean" === typeof isCustomComponentTag) {
                    var serverValue, propertyInfo = getPropertyInfo(propKey);
                    if (!suppressHydrationWarning && "suppressContentEditableWarning" !== propKey && "suppressHydrationWarning" !== propKey && "value" !== propKey && "checked" !== propKey && "selected" !== propKey) {
                      if ("dangerouslySetInnerHTML" === propKey) {
                        var serverHTML = newProps.innerHTML;
                        _i = _i ? _i.__html : void 0;
                        _i = normalizeHTML(newProps, null != _i ? _i : "");
                        _i !== serverHTML && warnForPropDifference(propKey, serverHTML, _i);
                        ...
                        if (extraAttributeNames.delete(propKey), canDiffStyleForHydrationWarning) {
                          ...
                          _i !== serverValue && warnForPropDifference(propKey, serverValue, _i);
                        }
                      } else if (isCustomComponentTag) {
                        extraAttributeNames.delete(propKey.toLowerCase()), serverValue = getValueForAttribute(newProps, propKey, _i), _i !== serverValue && warnForPropDifference(propKey, serverValue, _i);
                      } else if (!shouldIgnoreAttribute(propKey, propertyInfo, isCustomComponentTag) && !shouldRemoveAttribute(propKey, _i, propertyInfo, isCustomComponentTag)) {
                        serverHTML = !1;
                        if (null !== propertyInfo) {
                          b: {
                            if (extraAttributeNames.delete(propertyInfo.attributeName), styleValue = newProps, serverValue = propKey, delimiter = _i, propertyInfo.mustUseProperty) {
                          ...
                          serverValue = current, "http://www.w3.org/1999/xhtml" === serverValue && (serverValue = getIntrinsicNamespace(type)), "http://www.w3.org/1999/xhtml" === serverValue ? extraAttributeNames.delete(propKey.toLowerCase()) : (serverValue = propKey.toLowerCase(), serverValue = possibleStandardNames.hasOwnProperty(serverValue) ? possibleStandardNames[serverValue] || null : null, null !== serverValue && serverValue !== propKey && (serverHTML = !0, extraAttributeNames.delete(serverValue)), 
                          extraAttributeNames.delete(propKey)), serverValue = getValueForAttribute(newProps, propKey, _i);
                        }
                        _i === serverValue || serverHTML || warnForPropDifference(propKey, serverValue, _i);
                      }
                    }
                  }
                }
              }
              0 < extraAttributeNames.size && !suppressHydrationWarning && warnForExtraAttributes(extraAttributeNames);
              switch(type) {
                case "input":
                  track(newProps);
              ...
              renderExpirationTime = attributes;
              workInProgress.updateQueue = renderExpirationTime;
              null !== renderExpirationTime && (workInProgress.effectTag |= 4);
            } else {
              validateDOMNesting(type, null, current.ancestorInfo);
              if ("string" === typeof newProps.children || "number" === typeof newProps.children) {
                propKey = "" + newProps.children, extraAttributeNames = updatedAncestorInfo(current.ancestorInfo, type), validateDOMNesting(null, propKey, extraAttributeNames);
              }
              extraAttributeNames = 9 === renderExpirationTime.nodeType ? renderExpirationTime : renderExpirationTime.ownerDocument;
              propKey = current.namespace;
              "http://www.w3.org/1999/xhtml" === propKey && (propKey = getIntrinsicNamespace(type));
              "http://www.w3.org/1999/xhtml" === propKey ? ((isCustomComponentTag = isCustomComponent(type, newProps)) || type === type.toLowerCase() || error("\x3c%s /\x3e is using incorrect casing. Use PascalCase for React components, or lowercase for HTML elements.", type), "script" === type ? (current = extraAttributeNames.createElement("div"), current.innerHTML = "\x3cscript\x3e\x3c/script\x3e", current = current.removeChild(current.firstChild)) : "string" === typeof newProps.is ? current = 
              extraAttributeNames.createElement(type, {is:newProps.is}) : (current = extraAttributeNames.createElement(type), "select" === type && (extraAttributeNames = current, newProps.multiple ? extraAttributeNames.multiple = !0 : newProps.size && (extraAttributeNames.size = newProps.size)))) : current = extraAttributeNames.createElementNS(propKey, type);
              "http://www.w3.org/1999/xhtml" !== propKey || isCustomComponentTag || "[object HTMLUnknownElement]" !== Object.prototype.toString.call(current) || Object.prototype.hasOwnProperty.call(warnedUnknownTags, type) || (warnedUnknownTags[type] = !0, error("The tag \x3c%s\x3e is unrecognized in this browser. If you meant to render a React component, start its name with an uppercase letter.", type));
              propKey = current;
              propKey[internalInstanceKey] = workInProgress;
              propKey[internalEventHandlersKey] = newProps;
              appendAllChildren(propKey, workInProgress, !1, !1);
              workInProgress.stateNode = propKey;
              current = isCustomComponent(type, newProps);
              validatePropertiesInDevelopment(type, newProps);
              switch(type) {
                case "iframe":
                case "object":
                case "embed":
                  trapBubbledEvent("load", propKey);
                  isCustomComponentTag = newProps;
                  break;
                case "video":
                case "audio":
                  for (isCustomComponentTag = 0; isCustomComponentTag < mediaEventTypes.length; isCustomComponentTag++) {
                    trapBubbledEvent(mediaEventTypes[isCustomComponentTag], propKey);
                  }
                  isCustomComponentTag = newProps;
                  break;
                case "source":
                  trapBubbledEvent("error", propKey);
                  isCustomComponentTag = newProps;
                  break;
                case "img":
                case "image":
                case "link":
                  ...
                  break;
                case "form":
                  trapBubbledEvent("reset", propKey);
                  trapBubbledEvent("submit", propKey);
                  isCustomComponentTag = newProps;
                  break;
                case "details":
                  trapBubbledEvent("toggle", propKey);
                  isCustomComponentTag = newProps;
                  break;
                case "input":
                  initWrapperState(propKey, newProps);
                  isCustomComponentTag = getHostProps(propKey, newProps);
                  trapBubbledEvent("invalid", propKey);
                  ensureListeningTo(renderExpirationTime, "onChange");
                  break;
                case "option":
                  validateProps(propKey, newProps);
                  isCustomComponentTag = getHostProps$1(propKey, newProps);
                  break;
                case "select":
                  initWrapperState$1(propKey, newProps);
                  isCustomComponentTag = _assign({}, newProps, {value:void 0});
                  trapBubbledEvent("invalid", propKey);
                  ensureListeningTo(renderExpirationTime, "onChange");
                  break;
                case "textarea":
                  initWrapperState$2(propKey, newProps);
                  isCustomComponentTag = getHostProps$3(propKey, newProps);
                  trapBubbledEvent("invalid", propKey);
                  ensureListeningTo(renderExpirationTime, "onChange");
                  break;
                default:
        ...
        case 6:
          if (current && null != workInProgress.stateNode) {
            ...
            renderExpirationTime = requiredContext(rootInstanceStackCursor.current);
            propKey = requiredContext(contextStackCursor$1.current);
            if (popHydrationState(workInProgress)) {
              renderExpirationTime = workInProgress.stateNode;
              propKey = workInProgress.memoizedProps;
              renderExpirationTime[internalInstanceKey] = workInProgress;
              if (newProps = renderExpirationTime.nodeValue !== propKey) {
                if (type = hydrationParentFiber, null !== type) {
                  switch(type.tag) {
                    case 3:
                      warnForTextDifference(renderExpirationTime.nodeValue, propKey);
                      break;
                    case 5:
                      !0 !== type.memoizedProps[SUPPRESS_HYDRATION_WARNING$1] && warnForTextDifference(renderExpirationTime.nodeValue, propKey);
                  }
                }
              }
              newProps && (workInProgress.effectTag |= 4);
            } else {
              validateDOMNesting(null, newProps, propKey.ancestorInfo), renderExpirationTime = (9 === renderExpirationTime.nodeType ? renderExpirationTime : renderExpirationTime.ownerDocument).createTextNode(newProps), renderExpirationTime[internalInstanceKey] = workInProgress, workInProgress.stateNode = renderExpirationTime;
            }
          }
          return null;
        case 13:
          pop(suspenseStackCursor, workInProgress);
          propKey = workInProgress.memoizedState;
          ...
          propKey = !1;
          null === current ? void 0 !== workInProgress.memoizedProps.fallback && popHydrationState(workInProgress) : (newProps = current.memoizedState, propKey = null !== newProps, renderExpirationTime || null === newProps || (newProps = current.child.sibling, null !== newProps && (type = workInProgress.firstEffect, null !== type ? (workInProgress.firstEffect = newProps, newProps.nextEffect = type) : (workInProgress.firstEffect = workInProgress.lastEffect = newProps, newProps.nextEffect = null), 
          newProps.effectTag = 8)));
          if (renderExpirationTime && !propKey && 0 !== (workInProgress.mode & 2)) {
          ...
          if (renderExpirationTime || propKey) {
        ...
        case 19:
          ...
          newProps = 0 !== (workInProgress.effectTag & 64);
          type = propKey.rendering;
          if (null === type) {
            if (newProps) {
              cutOffTailIfNeeded(propKey, !1);
            } else {
              if (workInProgressRootExitStatus !== RootIncomplete || null !== current && 0 !== (current.effectTag & 64)) {
                for (type = workInProgress.child; null !== type;) {
                  props = findFirstSuspended(type);
                  if (null !== props) {
                    workInProgress.effectTag |= 64;
                    cutOffTailIfNeeded(propKey, !1);
                    newProps = props.updateQueue;
                    null !== newProps && (workInProgress.updateQueue = newProps, workInProgress.effectTag |= 4);
                    null === propKey.lastEffect && (workInProgress.firstEffect = null);
                    workInProgress.lastEffect = propKey.lastEffect;
                    for (propKey = workInProgress.child; null !== propKey;) {
                      newProps = propKey, props = renderExpirationTime, newProps.effectTag &= 2, newProps.nextEffect = null, newProps.firstEffect = null, newProps.lastEffect = null, type = newProps.alternate, null === type ? (newProps.childExpirationTime = 0, newProps.expirationTime = props, newProps.child = null, newProps.memoizedProps = null, newProps.memoizedState = null, newProps.updateQueue = null, newProps.dependencies = null, newProps.selfBaseDuration = 0, newProps.treeBaseDuration = 0) : 
                      (newProps.childExpirationTime = type.childExpirationTime, newProps.expirationTime = type.expirationTime, newProps.child = type.child, newProps.memoizedProps = type.memoizedProps, newProps.memoizedState = type.memoizedState, newProps.updateQueue = type.updateQueue, props = type.dependencies, newProps.dependencies = null === props ? null : {expirationTime:props.expirationTime, firstContext:props.firstContext, responders:props.responders}, newProps.selfBaseDuration = type.selfBaseDuration, 
                      newProps.treeBaseDuration = type.treeBaseDuration), propKey = propKey.sibling;
                    }
            ...
            if (!newProps) {
              if (props = findFirstSuspended(type), null !== props) {
                if (workInProgress.effectTag |= 64, newProps = !0, renderExpirationTime = props.updateQueue, null !== renderExpirationTime && (workInProgress.updateQueue = renderExpirationTime, workInProgress.effectTag |= 4), cutOffTailIfNeeded(propKey, !0), null === propKey.tail && "hidden" === propKey.tailMode && !type.alternate) {
                  return workInProgress = workInProgress.lastEffect = propKey.lastEffect, null !== workInProgress && (workInProgress.nextEffect = null), null;
                }
              } else {
                2 * now() - propKey.renderingStartTime > propKey.tailExpiration && 1 < renderExpirationTime && (workInProgress.effectTag |= 64, newProps = !0, cutOffTailIfNeeded(propKey, !1), --renderExpirationTime, workInProgress.expirationTime = workInProgress.childExpirationTime = renderExpirationTime, markSpawnedWork(renderExpirationTime));
              }
            }
            propKey.isBackwards ? (type.sibling = workInProgress.child, workInProgress.child = type) : (renderExpirationTime = propKey.last, null !== renderExpirationTime ? renderExpirationTime.sibling = type : workInProgress.child = type, propKey.last = type);
          }
          return null !== propKey.tail ? (0 === propKey.tailExpiration && (propKey.tailExpiration = now() + 500), renderExpirationTime = propKey.tail, propKey.rendering = renderExpirationTime, propKey.tail = renderExpirationTime.sibling, propKey.lastEffect = workInProgress.lastEffect, propKey.renderingStartTime = now(), renderExpirationTime.sibling = null, propKey = suspenseStackCursor.current, propKey = newProps ? propKey & SubtreeSuspenseContextMask | ForceSuspenseFallback : propKey & SubtreeSuspenseContextMask, 
          push(suspenseStackCursor, propKey, workInProgress), renderExpirationTime) : null;
      }
      throw Error("Unknown unit of work tag (" + workInProgress.tag + "). This error is likely caused by a bug in React. Please file an issue.");
    }
    function unwindWork(workInProgress, renderExpirationTime) {
      switch(workInProgress.tag) {
        case 1:
          return isContextProvider(workInProgress.type) && popContext(workInProgress), renderExpirationTime = workInProgress.effectTag, renderExpirationTime & 4096 ? (workInProgress.effectTag = renderExpirationTime & -4097 | 64, workInProgress) : null;
        case 3:
          popHostContainer(workInProgress);
          popTopLevelContextObject(workInProgress);
          renderExpirationTime = workInProgress.effectTag;
          if (0 !== (renderExpirationTime & 64)) {
        ...
        case 13:
          return pop(suspenseStackCursor, workInProgress), renderExpirationTime = workInProgress.effectTag, renderExpirationTime & 4096 ? (workInProgress.effectTag = renderExpirationTime & -4097 | 64, workInProgress) : null;
        case 19:
    ...
    function logCapturedError(capturedError) {
      var error = capturedError.error, componentName = capturedError.componentName, componentStack = capturedError.componentStack, errorBoundaryName = capturedError.errorBoundaryName, errorBoundaryFound = capturedError.errorBoundaryFound;
      capturedError = capturedError.willRetry;
      if (null != error && error._suppressLogging) {
        if (errorBoundaryFound && capturedError) {
          return;
        }
        console.error(error);
      }
      console.error((componentName ? "The above error occurred in the \x3c" + componentName + "\x3e component:" : "The above error occurred in one of your React components:") + componentStack + "\n\n" + (errorBoundaryFound && errorBoundaryName ? capturedError ? "React will try to recreate this component tree from scratch using the error boundary you provided, " + (errorBoundaryName + ".") : "This error was initially handled by the error boundary " + errorBoundaryName + ".\nRecreating the tree from scratch failed so React will unmount the tree." : 
    ...
    function logError(boundary, errorInfo) {
      ...
      errorInfo = {componentName:null !== source ? getComponentName(source.type) : null, componentStack:null !== stack ? stack : "", error:errorInfo.value, errorBoundary:null, errorBoundaryName:null, errorBoundaryFound:!1, willRetry:!1};
    ...
    function safelyCallComponentWillUnmount(current, instance) {
      ...
      hasError && (instance = clearCaughtError(), captureCommitPhaseError(current, instance));
    }
      ...
      switch(finishedWork.tag) {
        ...
        case 1:
          if (finishedWork.effectTag & 256 && null !== current) {
            ...
            finishedWork.type !== finishedWork.elementType || didWarnAboutReassigningProps || (current.props !== finishedWork.memoizedProps && error("Expected %s props to match memoized props before getSnapshotBeforeUpdate. This might either be because of a bug in React, or because a component reassigns its own `this.props`. Please file an issue.", getComponentName(finishedWork.type) || "instance"), current.state !== finishedWork.memoizedState && error("Expected %s state to match memoized state before getSnapshotBeforeUpdate. This might either be because of a bug in React, or because a component reassigns its own `this.props`. Please file an issue.", 
      ...
      if (null !== updateQueue) {
        ...
        do {
          if ((effect.tag & tag) === tag) {
            ...
            void 0 !== create && "function" !== typeof create && error("An effect function must not return anything besides a function, which is used for clean-up.%s%s", null === create ? " You returned null. If your effect does not require clean up, return undefined (or nothing)." : "function" === typeof create.then ? "\n\nIt looks like you wrote useEffect(async () \x3d\x3e ...) or returned a Promise. Instead, write the async function inside your effect and call it immediately:\n\nuseEffect(() \x3d\x3e {\n  async function fetchData() {\n    // You can await here\n    const response \x3d await MyAPI.getData(someId);\n    // ...\n  }\n  fetchData();\n}, [someId]); // Or [] if effect doesn't need props or state\n\nLearn more about data fetching with Hooks: https://fb.me/react-hooks-data-fetching" : 
            " You returned: " + create, getStackByFiberInDevAndProd(finishedWork));
          }
          effect = effect.next;
    ...
    function commitLifeCycles(finishedRoot, current, finishedWork, committedExpirationTime) {
      switch(finishedWork.tag) {
        ...
        case 1:
          ...
          finishedWork.effectTag & 4 && (null === current ? (startPhaseTimer(finishedWork, "componentDidMount"), finishedWork.type !== finishedWork.elementType || didWarnAboutReassigningProps || (finishedRoot.props !== finishedWork.memoizedProps && error("Expected %s props to match memoized props before componentDidMount. This might either be because of a bug in React, or because a component reassigns its own `this.props`. Please file an issue.", getComponentName(finishedWork.type) || "instance"), 
          finishedRoot.state !== finishedWork.memoizedState && error("Expected %s state to match memoized state before componentDidMount. This might either be because of a bug in React, or because a component reassigns its own `this.props`. Please file an issue.", getComponentName(finishedWork.type) || "instance")), finishedRoot.componentDidMount()) : (committedExpirationTime = finishedWork.elementType === finishedWork.type ? current.memoizedProps : resolveDefaultProps(finishedWork.type, current.memoizedProps), 
          ...
          finishedWork.memoizedState && error("Expected %s state to match memoized state before componentDidUpdate. This might either be because of a bug in React, or because a component reassigns its own `this.props`. Please file an issue.", getComponentName(finishedWork.type) || "instance")), finishedRoot.componentDidUpdate(committedExpirationTime, current, finishedRoot.__reactInternalSnapshotBeforeUpdate)), stopPhaseTimer());
          current = finishedWork.updateQueue;
          null !== current && (finishedWork.type !== finishedWork.elementType || didWarnAboutReassigningProps || (finishedRoot.props !== finishedWork.memoizedProps && error("Expected %s props to match memoized props before processing the update queue. This might either be because of a bug in React, or because a component reassigns its own `this.props`. Please file an issue.", getComponentName(finishedWork.type) || "instance"), finishedRoot.state !== finishedWork.memoizedState && error("Expected %s state to match memoized state before processing the update queue. This might either be because of a bug in React, or because a component reassigns its own `this.props`. Please file an issue.", 
        ...
        case 12:
          ...
          "function" === typeof committedExpirationTime && committedExpirationTime(finishedWork.memoizedProps.id, null === current ? "mount" : "update", finishedWork.actualDuration, finishedWork.treeBaseDuration, finishedWork.actualStartTime, commitTime, finishedRoot.memoizedInteractions);
          return;
        case 13:
            ...
            runWithPriority$1(97 < renderPriorityLevel ? 97 : renderPriorityLevel, function() {
              ...
              do {
                ...
                if (void 0 !== _destroy) {
                  ...
                  invokeGuardedCallback(null, _destroy, null);
                  hasError && (_destroy = clearCaughtError(), captureCommitPhaseError(current, _destroy));
                }
                effect = effect.next;
    ...
    function unmountHostComponents(finishedRoot$jscomp$0, current, renderPriorityLevel$jscomp$0) {
      for (var node = current, currentParentIsValid = !1, currentParent, currentParentIsContainer;;) {
        ...
        if (5 === node.tag || 6 === node.tag) {
          a: {
            for (var finishedRoot = finishedRoot$jscomp$0, root = node, renderPriorityLevel = renderPriorityLevel$jscomp$0, node$jscomp$0 = root;;) {
              if (commitUnmount(finishedRoot, node$jscomp$0, renderPriorityLevel), null !== node$jscomp$0.child && 4 !== node$jscomp$0.tag) {
                node$jscomp$0.child.return = node$jscomp$0, node$jscomp$0 = node$jscomp$0.child;
              } else {
                if (node$jscomp$0 === root) {
                  break a;
                }
          ...
          if (commitUnmount(finishedRoot$jscomp$0, node, renderPriorityLevel$jscomp$0), null !== node.child) {
            node.child.return = node;
            node = node.child;
            continue;
          }
    ...
    function commitWork(current, finishedWork) {
      switch(finishedWork.tag) {
        ...
        case 5:
          ...
          if (null != instance) {
            var newProps = finishedWork.memoizedProps, oldProps = null !== current ? current.memoizedProps : newProps;
          ...
          if (null !== instance) {
            a: {
              for (current = instance;;) {
                if (5 === current.tag) {
                  updatePayload = current.stateNode, newProps ? (updatePayload = updatePayload.style, "function" === typeof updatePayload.setProperty ? updatePayload.setProperty("display", "none", "important") : updatePayload.display = "none") : (updatePayload = current.stateNode, oldProps = current.memoizedProps.style, oldProps = void 0 !== oldProps && null !== oldProps && oldProps.hasOwnProperty("display") ? oldProps.display : null, updatePayload.style.display = dangerousStyleValue("display", oldProps));
                } else if (6 === current.tag) {
                  current.stateNode.nodeValue = newProps ? "" : current.memoizedProps;
                } else if (13 === current.tag && null !== current.memoizedState && null === current.memoizedState.dehydrated) {
    ...
    function attachSuspenseRetryListeners(finishedWork) {
      ...
      if (null !== thenables) {
        ...
        thenables.forEach(function(thenable) {
          ...
          retryCache.has(thenable) || (!0 !== thenable.__reactDoNotTraceInteractions && (retry = tracing.unstable_wrap(retry)), retryCache.add(thenable), thenable.then(retry, retry));
        });
      }
    }
    ...
    function createClassErrorUpdate(fiber, errorInfo, expirationTime) {
      ...
      expirationTime.callback = null !== inst && "function" === typeof inst.componentDidCatch ? function() {
        ...
        "function" !== typeof getDerivedStateFromError && 1073741823 !== fiber.expirationTime && error("%s: Error boundaries should implement getDerivedStateFromError(). In that method, return a state update to display an error message or fallback UI.", getComponentName(fiber.type) || "Unknown");
      } : function() {
        markFailedErrorBoundaryForHotReloading(fiber);
      };
      return expirationTime;
    ...
    function computeExpirationForFiber(currentTime, fiber, suspenseConfig) {
      ...
      if (null !== suspenseConfig) {
        currentTime = computeExpirationBucket(currentTime, suspenseConfig.timeoutMs | 0 || 5000, 250);
      } else {
        switch(priorityLevel) {
          case 99:
            ...
            break;
          case 98:
            currentTime = computeExpirationBucket(currentTime, 500, 100);
            break;
          case 97:
          case 96:
            currentTime = computeExpirationBucket(currentTime, 5000, 250);
            break;
          case 95:
            currentTime = 2;
            break;
    ...
    function markUpdateTimeFromFiberToRoot(fiber, expirationTime) {
      ...
      var node = fiber.return, root = null;
      if (null === node && 3 === fiber.tag) {
    ...
    function ensureRootIsScheduled(root) {
      if (0 !== root.lastExpiredTime) {
        root.callbackExpirationTime = 1073741823, root.callbackPriority = 99, root.callbackNode = scheduleSyncCallback(performSyncWorkOnRoot.bind(null, root));
      } else {
        var expirationTime = getNextRootExpirationTimeToWorkOn(root), existingCallbackNode = root.callbackNode;
        if (0 === expirationTime) {
          null !== existingCallbackNode && (root.callbackNode = null, root.callbackExpirationTime = 0, root.callbackPriority = 90);
        } else {
          var currentTime = requestCurrentTimeForUpdate();
          currentTime = inferPriorityFromExpirationTime(currentTime, expirationTime);
          if (null !== existingCallbackNode) {
            var existingCallbackPriority = root.callbackPriority;
            if (root.callbackExpirationTime === expirationTime && existingCallbackPriority >= currentTime) {
              return;
            }
          ...
          expirationTime = 1073741823 === expirationTime ? scheduleSyncCallback(performSyncWorkOnRoot.bind(null, root)) : scheduleCallback(currentTime, performConcurrentWorkOnRoot.bind(null, root), {timeout:10 * (1073741821 - expirationTime) - now()});
    ...
    function performConcurrentWorkOnRoot(root, didTimeout) {
      currentEventTime = 0;
      if (didTimeout) {
        return didTimeout = requestCurrentTimeForUpdate(), markRootExpiredAtTime(root, didTimeout), ensureRootIsScheduled(root), null;
      }
      ...
      if (0 !== expirationTime) {
        ...
        if (null !== workInProgress) {
          ...
          var prevDispatcher = pushDispatcher(), prevInteractions = pushInteractions(root);
          ...
          if (workInProgressRootExitStatus === RootFatalErrored) {
            throw didTimeout = workInProgressRootFatalError, stopWorkLoopTimer(interruptedBy, !1), interruptedBy = null, prepareFreshStack(root, expirationTime), markRootSuspendedAtTime(root, expirationTime), ensureRootIsScheduled(root), didTimeout;
          }
          if (null !== workInProgress) {
            stopWorkLoopTimer(interruptedBy, !1), interruptedBy = null;
          } else {
            switch(stopWorkLoopTimer(interruptedBy, !0), interruptedBy = null, prevDispatcher = root.finishedWork = root.current.alternate, root.finishedExpirationTime = expirationTime, prevExecutionContext = workInProgressRootExitStatus, workInProgressRoot = null, prevExecutionContext) {
              case RootIncomplete:
              ...
              case RootSuspended:
                ...
                if (1073741823 === workInProgressRootLatestProcessedExpirationTime && !IsThisRendererActing.current && (prevDispatcher = globalMostRecentFallbackTime + FALLBACK_THROTTLE_MS - now(), 10 < prevDispatcher)) {
                  if (workInProgressRootHasPendingPing && (prevInteractions = root.lastPingedTime, 0 === prevInteractions || prevInteractions >= expirationTime)) {
              ...
              case RootSuspendedWithDelay:
                ...
                break;
              case RootCompleted:
                if (!IsThisRendererActing.current && 1073741823 !== workInProgressRootLatestProcessedExpirationTime && null !== workInProgressRootCanSuspendUsingConfig) {
                  ...
                  0 >= prevExecutionContext ? prevExecutionContext = 0 : (prevDispatcher = suspenseConfig.busyDelayMs | 0, prevInteractions = now() - (10 * (1073741821 - prevInteractions) - (suspenseConfig.timeoutMs | 0 || 5000)), prevExecutionContext = prevInteractions <= prevDispatcher ? 0 : prevDispatcher + prevExecutionContext - prevInteractions);
                  if (10 < prevExecutionContext) {
                    markRootSuspendedAtTime(root, expirationTime);
                    root.timeoutHandle = scheduleTimeout(commitRoot.bind(null, root), prevExecutionContext);
                    break;
    ...
    function performSyncWorkOnRoot(root) {
      ...
      if (root !== workInProgressRoot || lastExpiredTime !== renderExpirationTime$1) {
        prepareFreshStack(root, lastExpiredTime), startWorkOnPendingInteractions(root, lastExpiredTime);
      }
      if (null !== workInProgress) {
        var prevExecutionContext = executionContext;
        executionContext |= RenderContext;
        ...
        tracing.__interactionsRef.current = prevInteractions;
        if (workInProgressRootExitStatus === RootFatalErrored) {
          throw prevExecutionContext = workInProgressRootFatalError, stopWorkLoopTimer(interruptedBy, !1), interruptedBy = null, prepareFreshStack(root, lastExpiredTime), markRootSuspendedAtTime(root, lastExpiredTime), ensureRootIsScheduled(root), prevExecutionContext;
        }
        if (null !== workInProgress) {
      ...
      do {
        try {
          ...
          if (null === workInProgress || null === workInProgress.return) {
            return workInProgressRootExitStatus = RootFatalErrored, workInProgressRootFatalError = thrownValue, workInProgress = null;
          }
          workInProgress.mode & 8 && stopProfilerTimerIfRunningAndRecordDelta(workInProgress, !0);
          a: {
            var root = root$jscomp$0, returnFiber = workInProgress.return, sourceFiber = workInProgress, value = thrownValue;
            ...
            if (null !== value && "object" === typeof value && "function" === typeof value.then) {
              ...
              value = Error((getComponentName(sourceFiber.type) || "A React component") + " suspended while rendering, but no fallback UI was specified.\n\nAdd a \x3cSuspense fallback\x3d...\x3e component higher in the tree to provide a loading indicator or placeholder to display." + getStackByFiberInDevAndProd(sourceFiber));
            }
    ...
    function pushDispatcher(root) {
      root = ReactCurrentDispatcher$1.current;
      ReactCurrentDispatcher$1.current = ContextOnlyDispatcher;
      return null === root ? ContextOnlyDispatcher : root;
    }
    ...
    function performUnitOfWork(unitOfWork) {
      ...
      0 !== (unitOfWork.mode & 8) ? (startProfilerTimer(unitOfWork), current = beginWork$1(current, unitOfWork, renderExpirationTime$1), stopProfilerTimerIfRunningAndRecordDelta(unitOfWork, !0)) : current = beginWork$1(current, unitOfWork, renderExpirationTime$1);
      resetCurrentFiber();
    ...
    function completeUnitOfWork(unitOfWork) {
      ...
      do {
        ...
        if (0 === (workInProgress.effectTag & 2048)) {
          ...
          0 === (workInProgress.mode & 8) ? current = completeWork(current, workInProgress, renderExpirationTime$1) : (startProfilerTimer(workInProgress), current = completeWork(current, workInProgress, renderExpirationTime$1), stopProfilerTimerIfRunningAndRecordDelta(workInProgress, !1));
          ...
          if (1 === renderExpirationTime$1 || 1 !== completedWork.childExpirationTime) {
            ...
            if (0 !== (completedWork.mode & 8)) {
              for (var actualDuration = completedWork.actualDuration, treeBaseDuration = completedWork.selfBaseDuration, shouldBubbleActualDurations = null === completedWork.alternate || completedWork.child !== completedWork.alternate.child, child = completedWork.child; null !== child;) {
                var childUpdateExpirationTime = child.expirationTime, childChildExpirationTime = child.childExpirationTime;
              ...
              for (actualDuration = completedWork.child; null !== actualDuration;) {
                treeBaseDuration = actualDuration.expirationTime, shouldBubbleActualDurations = actualDuration.childExpirationTime, treeBaseDuration > newChildExpirationTime && (newChildExpirationTime = treeBaseDuration), shouldBubbleActualDurations > newChildExpirationTime && (newChildExpirationTime = shouldBubbleActualDurations), actualDuration = actualDuration.sibling;
              }
            }
          ...
          if (0 !== (workInProgress.mode & 8)) {
            ...
            completedWork = workInProgress.actualDuration;
            for (newChildExpirationTime = workInProgress.child; null !== newChildExpirationTime;) {
              completedWork += newChildExpirationTime.actualDuration, newChildExpirationTime = newChildExpirationTime.sibling;
            }
            workInProgress.actualDuration = completedWork;
          }
          if (null !== current) {
            return unitOfWork = workInProgress, supportsUserTiming && !shouldIgnoreFiber(unitOfWork) && (currentFiber = unitOfWork.return, unitOfWork._debugIsCurrentlyTiming && (unitOfWork._debugIsCurrentlyTiming = !1, endFiberMark(unitOfWork, null, 13 === unitOfWork.tag ? "Rendering was suspended" : "An error was thrown inside this error boundary"))), current.effectTag &= 2047, current;
          }
          stopWorkTimer(workInProgress);
    ...
    function commitRootImpl(root, renderPriorityLevel) {
      ...
      var finishedWork = root.finishedWork, expirationTime = root.finishedExpirationTime;
      if (null === finishedWork) {
        return null;
      }
      root.finishedWork = null;
      ...
      if (null !== remainingExpirationTimeBeforeCommit) {
        ...
        if (hasSelectionCapabilities(focusedElem)) {
          if ("selectionStart" in focusedElem) {
            var JSCompiler_temp = {start:focusedElem.selectionStart, end:focusedElem.selectionEnd};
          } else {
            a: {
              ...
              if (selection && 0 !== selection.rangeCount) {
                ...
                var length = 0, start = -1, end = -1, indexWithinAnchor = 0, indexWithinFocus = 0, node = focusedElem, parentNode = null;
                b: for (;;) {
                  for (var next;;) {
        ...
        selectionInformation = {activeElementDetached:null, focusedElem, selectionRange:JSCompiler_temp};
        _enabled = !1;
        ...
        do {
          if (invokeGuardedCallback(null, commitBeforeMutationEffects, null), hasError) {
            ...
            captureCommitPhaseError(nextEffect, focusedElem);
        ...
        if (JSCompiler_temp !== focusedElem && focusedElem && focusedElem.ownerDocument && containsNode(focusedElem.ownerDocument.documentElement, focusedElem)) {
          ...
          anchorOffset.anchorNode !== length.node || anchorOffset.anchorOffset !== length.offset || anchorOffset.focusNode !== start.node || anchorOffset.focusOffset !== start.offset) && (JSCompiler_temp = JSCompiler_temp.createRange(), JSCompiler_temp.setStart(length.node, length.offset), anchorOffset.removeAllRanges(), focusNode > selection ? (anchorOffset.addRange(JSCompiler_temp), anchorOffset.extend(start.node, start.offset)) : (JSCompiler_temp.setEnd(start.node, start.offset), anchorOffset.addRange(JSCompiler_temp))))));
          JSCompiler_temp = [];
          for (anchorOffset = focusedElem; anchorOffset = anchorOffset.parentNode;) {
            1 === anchorOffset.nodeType && JSCompiler_temp.push({element:anchorOffset, left:anchorOffset.scrollLeft, top:anchorOffset.scrollTop});
          }
          "function" === typeof focusedElem.focus && focusedElem.focus();
          for (focusedElem = 0; focusedElem < JSCompiler_temp.length; focusedElem++) {
            anchorOffset = JSCompiler_temp[focusedElem], anchorOffset.element.scrollLeft = anchorOffset.left, anchorOffset.element.scrollTop = anchorOffset.top;
          }
        }
        ...
        nextEffect = remainingExpirationTimeBeforeCommit;
        do {
          if (invokeGuardedCallback(null, commitLayoutEffects, null, root, expirationTime), hasError) {
            if (null === nextEffect) {
              throw Error("Should be working on an effect.");
            }
            focusedElem = clearCaughtError();
        ...
        root.current = finishedWork, startCommitSnapshotEffectsTimer(), stopCommitSnapshotEffectsTimer(), commitTime = now$1(), startCommitHostEffectsTimer(), stopCommitHostEffectsTimer(), startCommitLifeCyclesTimer(), stopCommitLifeCyclesTimer();
      }
      supportsUserTiming && (prevExecutionContext = null, hasScheduledUpdateInCurrentCommit ? prevExecutionContext = "Lifecycle hook scheduled a cascading update" : 0 < commitCountInCurrentWorkLoop && (prevExecutionContext = "Caused by a cascading update in earlier commit"), hasScheduledUpdateInCurrentCommit = !1, commitCountInCurrentWorkLoop++, isCommitting = !1, labelsInCurrentCommit.clear(), endMark("(Committing Changes)", "(Committing Changes)", prevExecutionContext));
      if (prevExecutionContext = rootDoesHavePassiveEffects) {
        rootDoesHavePassiveEffects = !1, rootWithPendingPassiveEffects = root, pendingPassiveEffectsExpirationTime = expirationTime, pendingPassiveEffectsRenderPriority = renderPriorityLevel;
      } else {
        for (nextEffect = remainingExpirationTimeBeforeCommit; null !== nextEffect;) {
      ...
      if (0 !== renderPriorityLevel) {
        if (null !== spawnedWorkDuringRender) {
          for (remainingExpirationTimeBeforeCommit = spawnedWorkDuringRender, spawnedWorkDuringRender = null, prevInteractions = 0; prevInteractions < remainingExpirationTimeBeforeCommit.length; prevInteractions++) {
            scheduleInteractions(root, remainingExpirationTimeBeforeCommit[prevInteractions], root.memoizedInteractions);
          }
        }
      ...
      prevExecutionContext || finishPendingInteractions(root, expirationTime);
    ...
    function commitBeforeMutationEffects() {
      for (; null !== nextEffect;) {
        ...
        0 !== (effectTag & 256) && (setCurrentFiber(nextEffect), effectCountInCurrentCommit++, commitBeforeMutationLifeCycles(nextEffect.alternate, nextEffect), resetCurrentFiber());
      ...
      for (; null !== nextEffect;) {
        ...
        switch(effectTag & 1038) {
          ...
          case 4:
            ...
            break;
          case 8:
            effectTag = nextEffect, unmountHostComponents(root, effectTag, renderPriorityLevel), detachFiber(effectTag);
        }
    ...
    function commitLayoutEffects(root, committedExpirationTime) {
      for (; null !== nextEffect;) {
        setCurrentFiber(nextEffect);
        committedExpirationTime = nextEffect.effectTag;
        committedExpirationTime & 36 && (effectCountInCurrentCommit++, commitLifeCycles(root, nextEffect.alternate, nextEffect));
        if (committedExpirationTime & 128) {
          effectCountInCurrentCommit++;
          committedExpirationTime = nextEffect;
          var ref = committedExpirationTime.ref;
          if (null !== ref) {
            var instanceToUse = committedExpirationTime.stateNode;
            "function" === typeof ref ? ref(instanceToUse) : (ref.hasOwnProperty("current") || error("Unexpected ref object provided for %s. Use either a ref-setter function or React.createRef().%s", getComponentName(committedExpirationTime.type), getStackByFiberInDevAndProd(committedExpirationTime)), ref.current = instanceToUse);
          }
        }
        resetCurrentFiber();
        nextEffect = nextEffect.nextEffect;
    ...
    function flushPassiveEffectsImpl() {
      ...
      var root = rootWithPendingPassiveEffects, expirationTime = pendingPassiveEffectsExpirationTime;
      ...
      var prevExecutionContext = executionContext;
      executionContext |= CommitContext;
      for (var prevInteractions = pushInteractions(root), _effect2 = root.current.firstEffect; null !== _effect2;) {
    ...
    function captureCommitPhaseErrorOnRoot(rootFiber, sourceFiber, error) {
      ...
      null !== rootFiber && (ensureRootIsScheduled(rootFiber), schedulePendingInteractions(rootFiber, 1073741823));
    }
        ...
        for (var fiber = sourceFiber.return; null !== fiber;) {
          if (3 === fiber.tag) {
            ...
            if ("function" === typeof fiber.type.getDerivedStateFromError || "function" === typeof instance.componentDidCatch && (null === legacyErrorBoundariesThatAlreadyFailed || !legacyErrorBoundariesThatAlreadyFailed.has(instance))) {
              ...
              null !== fiber && (ensureRootIsScheduled(fiber), schedulePendingInteractions(fiber, 1073741823));
              break;
            }
          }
          fiber = fiber.return;
    ...
    function pingSuspendedRoot(root, thenable, suspendedTime) {
      ...
      workInProgressRoot === root && renderExpirationTime$1 === suspendedTime ? workInProgressRootExitStatus === RootSuspendedWithDelay || workInProgressRootExitStatus === RootSuspended && 1073741823 === workInProgressRootLatestProcessedExpirationTime && now() - globalMostRecentFallbackTime < FALLBACK_THROTTLE_MS ? prepareFreshStack(root, renderExpirationTime$1) : workInProgressRootHasPendingPing = !0 : isRootSuspendedAtTime(root, suspendedTime) && (thenable = root.lastPingedTime, 0 !== thenable && 
      thenable < suspendedTime || (root.lastPingedTime = suspendedTime, ensureRootIsScheduled(root), schedulePendingInteractions(root, suspendedTime)));
    }
    function resolveRetryThenable(boundaryFiber, thenable) {
      ...
      null !== boundaryFiber && (ensureRootIsScheduled(boundaryFiber), schedulePendingInteractions(boundaryFiber, thenable));
    }
    function warnIfNotScopedWithMatchingAct(fiber) {
      !0 === IsSomeRendererActing.current && !0 !== IsThisRendererActing.current && error("It looks like you're using the wrong act() around your test interactions.\nBe sure to use the matching version of act() corresponding to your renderer:\n\n// for react-dom:\nimport {act} from 'react-dom/test-utils';\n// ...\nact(() \x3d\x3e ...);\n\n// for react-test-renderer:\nimport TestRenderer from 'react-test-renderer';\nconst {act} \x3d TestRenderer;\n// ...\nact(() \x3d\x3e ...);%s", getStackByFiberInDevAndProd(fiber));
    }
    ...
    function markSpawnedWork(expirationTime) {
      null === spawnedWorkDuringRender ? spawnedWorkDuringRender = [expirationTime] : spawnedWorkDuringRender.push(expirationTime);
    }
    function scheduleInteractions(root, expirationTime, interactions) {
      if (0 < interactions.size) {
        var pendingInteractionMap = root.pendingInteractionMap, pendingInteractions = pendingInteractionMap.get(expirationTime);
        ...
        if (null !== pendingInteractionMap) {
          pendingInteractionMap.onWorkScheduled(interactions, 1000 * expirationTime + root.interactionThreadID);
        }
      }
    }
    ...
    function startWorkOnPendingInteractions(root, expirationTime) {
      ...
      if (0 < interactions.size) {
        ...
        if (null !== subscriber) {
          root = 1000 * expirationTime + root.interactionThreadID;
          try {
    ...
    function finishPendingInteractions(root, committedExpirationTime) {
      ...
      try {
        ...
        if (null !== subscriber && 0 < root.memoizedInteractions.size) {
          subscriber.onWorkStopped(root.memoizedInteractions, 1000 * committedExpirationTime + root.interactionThreadID);
        }
      } catch (error) {
        scheduleCallback(99, function() {
          throw error;
        ...
        pendingInteractionMap.forEach(function(scheduledInteractions, scheduledExpirationTime) {
          scheduledExpirationTime > earliestRemainingTimeAfterCommit && (pendingInteractionMap.delete(scheduledExpirationTime), scheduledInteractions.forEach(function(interaction) {
            interaction.__count--;
    ...
    function injectInternals(internals) {
      ...
      if (!hook.supportsFiber) {
        return error("The installed version of React DevTools is too old and will not work with the current version of React. Please update React DevTools. https://fb.me/react-devtools"), !0;
      }
      try {
        var rendererID = hook.inject(internals);
        "function" === typeof hook.onScheduleFiberRoot && (onScheduleFiberRoot = function(root, children) {
          try {
        ...
        onCommitFiberRoot = function(root, expirationTime) {
          try {
            var didError = 64 === (root.current.effectTag & 64), currentTime = 1073741821 - (now() / 10 | 0), priorityLevel = inferPriorityFromExpirationTime(currentTime, expirationTime);
    ...
    function createWorkInProgress(current, pendingProps) {
      ...
      workInProgress) : (workInProgress.pendingProps = pendingProps, workInProgress.effectTag = 0, workInProgress.nextEffect = null, workInProgress.firstEffect = null, workInProgress.lastEffect = null, workInProgress.actualDuration = 0, workInProgress.actualStartTime = -1);
      ...
      workInProgress.dependencies = null === pendingProps ? null : {expirationTime:pendingProps.expirationTime, firstContext:pendingProps.firstContext, responders:pendingProps.responders};
        ...
        a: {
          switch(type) {
            ...
            case REACT_STRICT_MODE_TYPE:
              ...
              break;
            case REACT_PROFILER_TYPE:
              return type = mode, "string" === typeof pendingProps.id && "function" === typeof pendingProps.onRender || error('Profiler must specify an "id" string and "onRender" function as props'), type = createFiber(12, pendingProps, key, type | 8), type.elementType = REACT_PROFILER_TYPE, type.type = REACT_PROFILER_TYPE, type.expirationTime = expirationTime, type;
            case REACT_SUSPENSE_TYPE:
            ...
            case REACT_SUSPENSE_LIST_TYPE:
              return type = createFiber(19, pendingProps, key, mode), type.type = REACT_SUSPENSE_LIST_TYPE, type.elementType = REACT_SUSPENSE_LIST_TYPE, type.expirationTime = expirationTime, type;
            default:
              ...
              if (void 0 === type || "object" === typeof type && null !== type && 0 === Object.keys(type).length) {
                expirationTime += " You likely forgot to export your component from the file it's defined in, or you might have mixed up default and named imports.";
              }
              (key = owner ? getComponentName(owner.type) : null) && (expirationTime += "\n\nCheck the render method of `" + key + "`.");
              throw Error("Element type is invalid: expected a string (for built-in components) or a class/function (for composite components) but got: " + (null == type ? type : typeof type) + "." + expirationTime);
          }
        }
      }
    ...
    function createFiberFromElement(element, mode, expirationTime) {
      mode = createFiberFromTypeAndProps(element.type, element.key, element.props, element._owner, mode, expirationTime);
    ...
    function markRootSuspendedAtTime(root, expirationTime) {
      var firstSuspendedTime = root.firstSuspendedTime, lastSuspendedTime = root.lastSuspendedTime;
    ...
    function updateContainer(element, container, parentComponent, callback) {
      "function" === typeof onScheduleFiberRoot && onScheduleFiberRoot(container, element);
      var current$1 = container.current, currentTime = requestCurrentTimeForUpdate();
      ...
      var suspenseConfig = ReactCurrentBatchConfig.suspense;
      currentTime = computeExpirationForFiber(currentTime, current$1, suspenseConfig);
      a: {
        if (parentComponent) {
      ...
      scheduleWork(current$1, currentTime);
      return currentTime;
    }
    ...
    function ReactDOMBlockingRoot(container, tag, options) {
      ...
      var uninitializedFiber = 2 === tag ? 7 : 1 === tag ? 3 : 0;
    ...
    function legacyCreateRootFromDOMContainer(container, forceHydrate) {
      ...
      !JSCompiler_temp || forceHydrate || warnedAboutHydrateAPI || (warnedAboutHydrateAPI = !0, warn("render(): Calling ReactDOM.render() to hydrate server-rendered markup will stop working in React v17. Replace the ReactDOM.render() call with ReactDOM.hydrate() if you want React to attach to the server HTML."));
    ...
    var React = require("module$node_modules$react$index"), _assign = require("module$node_modules$object_assign$index"), Scheduler = require("module$node_modules$scheduler$index"), checkPropTypes = require("module$node_modules$prop_types$checkPropTypes"), tracing = require("module$node_modules$scheduler$tracing"), ReactSharedInternals = React.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
    ReactSharedInternals.hasOwnProperty("ReactCurrentDispatcher") || (ReactSharedInternals.ReactCurrentDispatcher = {current:null});
    ReactSharedInternals.hasOwnProperty("ReactCurrentBatchConfig") || (ReactSharedInternals.ReactCurrentBatchConfig = {suspense:null});
    if (!React) {
    ...
    if ("undefined" !== typeof window && "function" === typeof window.dispatchEvent && "undefined" !== typeof document && "function" === typeof document.createEvent) {
      ...
      invokeGuardedCallbackImpl = function(name, func, context, a, b, c, d, e, f) {
        ...
        var evt = document.createEvent("Event"), didError = !0, windowEvent = window.event, windowEventDescriptor = Object.getOwnPropertyDescriptor(window, "event"), funcArgs = Array.prototype.slice.call(arguments, 3), error, didSetError = !1, isCrossOriginError = !1, evtType = "react-" + (name ? name : "invokeguardedcallback");
    ...
    var invokeGuardedCallbackImpl$1 = invokeGuardedCallbackImpl, hasError = !1, caughtError = null, hasRethrowError = !1, rethrowError = null, reporter = {onError:function(error) {
      hasError = !0;
      caughtError = error;
    }}, getFiberCurrentPropsFromNode = null, getInstanceFromNode = null, getNodeFromInstance = null;
    var validateEventDispatches = function(event) {
      ...
      dispatchListeners = (event = Array.isArray(dispatchListeners)) ? dispatchListeners.length : dispatchListeners ? 1 : 0;
      var instancesIsArr = Array.isArray(dispatchInstances);
      dispatchInstances = instancesIsArr ? dispatchInstances.length : dispatchInstances ? 1 : 0;
      instancesIsArr === event && dispatchInstances === dispatchListeners || error("EventPluginUtils: Invalid `event`.");
    };
    var eventPluginOrder = null, namesToPlugins = {}, plugins = [], eventNameDispatchConfigs = {}, registrationNameModules = {}, registrationNameDependencies = {}, possibleRegistrationNames = {}, canUseDOM = !("undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement), restoreImpl = null, restoreTarget = null, restoreQueue = null, batchedUpdatesImpl = function(fn, bookkeeping) {
      return fn(bookkeeping);
    }, discreteUpdatesImpl = function(fn, a, b, c, d) {
      return fn(a, b, c, d);
    }, flushDiscreteUpdatesImpl = function() {
    }, batchedEventUpdatesImpl = batchedUpdatesImpl, isInsideEventHandler = !1, isBatchingEventUpdates = !1, VALID_ATTRIBUTE_NAME_REGEX = RegExp("^[:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD][:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040]*$"), 
    ...
    hasSymbol ? Symbol.for("react.suspense_list") : 60120, REACT_MEMO_TYPE = hasSymbol ? Symbol.for("react.memo") : 60115, REACT_LAZY_TYPE = hasSymbol ? Symbol.for("react.lazy") : 60116, REACT_BLOCK_TYPE = hasSymbol ? Symbol.for("react.block") : 60121, MAYBE_ITERATOR_SYMBOL = "function" === typeof Symbol && Symbol.iterator, ReactDebugCurrentFrame$1 = ReactSharedInternals.ReactDebugCurrentFrame, current = null, isRendering = !1, ReactDebugCurrentFrame$2 = null, ReactControlledValuePropTypes = {checkPropTypes:null};
    ReactDebugCurrentFrame$2 = ReactSharedInternals.ReactDebugCurrentFrame;
    var hasReadOnlyValue = {button:!0, checkbox:!0, image:!0, hidden:!0, radio:!0, reset:!0, submit:!0}, propTypes = {value:function(props, propName, componentName) {
      return hasReadOnlyValue[props.type] || props.onChange || props.readOnly || props.disabled || null == props[propName] ? null : Error("You provided a `value` prop to a form field without an `onChange` handler. This will render a read-only field. If the field should be mutable use `defaultValue`. Otherwise, set either `onChange` or `readOnly`.");
    }, checked:function(props, propName, componentName) {
      return props.onChange || props.readOnly || props.disabled || null == props[propName] ? null : Error("You provided a `checked` prop to a form field without an `onChange` handler. This will render a read-only field. If the field should be mutable use `defaultChecked`. Otherwise, set either `onChange` or `readOnly`.");
    }};
    ReactControlledValuePropTypes.checkPropTypes = function(tagName, props) {
      checkPropTypes(propTypes, props, "prop", tagName, ReactDebugCurrentFrame$2.getStackAddendum);
    };
    var didWarnValueDefaultValue = !1, didWarnCheckedDefaultChecked = !1, didWarnControlledToUncontrolled = !1, didWarnUncontrolledToControlled = !1, didWarnSelectedSetOnOption = !1, didWarnInvalidChild = !1;
    ...
    elementListenerMap = new ("function" === typeof WeakMap ? WeakMap : Map)(), ReactCurrentOwner = ReactSharedInternals.ReactCurrentOwner, eventQueue = null, executeDispatchesAndReleaseTopLevel = function(e) {
      if (e) {
        ...
        if (Array.isArray(dispatchListeners)) {
          ...
          dispatchListeners && executeDispatch(e, dispatchListeners, dispatchInstances);
        }
        e._dispatchListeners = null;
        e._dispatchInstances = null;
        e.isPersistent() || e.constructor.release(e);
      }
    }, callbackBookkeepingPool = [], hasScheduledReplayAttempt = !1, queuedDiscreteEvents = [], queuedFocus = null, queuedDrag = null, queuedMouse = null, queuedPointers = new Map(), queuedPointerCaptures = new Map(), queuedExplicitHydrationTargets = [], discreteReplayableEvents = "mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput close cancel copy cut paste click change contextmenu reset submit".split(" "), 
    continuousReplayableEvents = "focus blur dragenter dragleave mouseover mouseout pointerover pointerout gotpointercapture lostpointercapture".split(" "), simpleEventPluginEventTypes = {}, topLevelEventsToDispatchConfig = new Map(), eventPriorities = new Map(), continuousPairsForSimpleEventPlugin = ["abort", "abort", TOP_ANIMATION_END, "animationEnd", TOP_ANIMATION_ITERATION, "animationIteration", TOP_ANIMATION_START, "animationStart", "canplay", "canPlay", "canplaythrough", "canPlayThrough", "durationchange", 
    "durationChange", "emptied", "emptied", "encrypted", "encrypted", "ended", "ended", "error", "error", "gotpointercapture", "gotPointerCapture", "load", "load", "loadeddata", "loadedData", "loadedmetadata", "loadedMetadata", "loadstart", "loadStart", "lostpointercapture", "lostPointerCapture", "playing", "playing", "progress", "progress", "seeking", "seeking", "stalled", "stalled", "suspend", "suspend", "timeupdate", "timeUpdate", TOP_TRANSITION_END, "transitionEnd", "waiting", "waiting"];
    ...
    var UserBlockingPriority = Scheduler.unstable_UserBlockingPriority, runWithPriority = Scheduler.unstable_runWithPriority, _enabled = !0, shorthandToLonghand = {animation:"animationDelay animationDirection animationDuration animationFillMode animationIterationCount animationName animationPlayState animationTimingFunction".split(" "), background:"backgroundAttachment backgroundClip backgroundColor backgroundImage backgroundOrigin backgroundPositionX backgroundPositionY backgroundRepeat backgroundSize".split(" "), 
    ...
    "borderBlockStartStyle", "borderBlockStartWidth"], borderBottom:["borderBottomColor", "borderBottomStyle", "borderBottomWidth"], borderColor:["borderBottomColor", "borderLeftColor", "borderRightColor", "borderTopColor"], borderImage:["borderImageOutset", "borderImageRepeat", "borderImageSlice", "borderImageSource", "borderImageWidth"], borderInlineEnd:["borderInlineEndColor", "borderInlineEndStyle", "borderInlineEndWidth"], borderInlineStart:["borderInlineStartColor", "borderInlineStartStyle", 
    "borderInlineStartWidth"], borderLeft:["borderLeftColor", "borderLeftStyle", "borderLeftWidth"], borderRadius:["borderBottomLeftRadius", "borderBottomRightRadius", "borderTopLeftRadius", "borderTopRightRadius"], borderRight:["borderRightColor", "borderRightStyle", "borderRightWidth"], borderStyle:["borderBottomStyle", "borderLeftStyle", "borderRightStyle", "borderTopStyle"], borderTop:["borderTopColor", "borderTopStyle", "borderTopWidth"], borderWidth:["borderBottomWidth", "borderLeftWidth", 
    "borderRightWidth", "borderTopWidth"], columnRule:["columnRuleColor", "columnRuleStyle", "columnRuleWidth"], columns:["columnCount", "columnWidth"], flex:["flexBasis", "flexGrow", "flexShrink"], flexFlow:["flexDirection", "flexWrap"], font:"fontFamily fontFeatureSettings fontKerning fontLanguageOverride fontSize fontSizeAdjust fontStretch fontStyle fontVariant fontVariantAlternates fontVariantCaps fontVariantEastAsian fontVariantLigatures fontVariantNumeric fontVariantPosition fontWeight lineHeight".split(" "), 
    ...
    }, voidElementTags = _assign({menuitem:!0}, {area:!0, base:!0, br:!0, col:!0, embed:!0, hr:!0, img:!0, input:!0, keygen:!0, link:!0, meta:!0, param:!0, source:!0, track:!0, wbr:!0}), ReactDebugCurrentFrame$3 = null;
    ReactDebugCurrentFrame$3 = ReactSharedInternals.ReactDebugCurrentFrame;
    var possibleStandardNames = {accept:"accept", acceptcharset:"acceptCharset", "accept-charset":"acceptCharset", accesskey:"accessKey", action:"action", allowfullscreen:"allowFullScreen", alt:"alt", as:"as", async:"async", autocapitalize:"autoCapitalize", autocomplete:"autoComplete", autocorrect:"autoCorrect", autofocus:"autoFocus", autoplay:"autoPlay", autosave:"autoSave", capture:"capture", cellpadding:"cellPadding", cellspacing:"cellSpacing", challenge:"challenge", charset:"charSet", checked:"checked", 
    children:"children", cite:"cite", class:"className", classid:"classID", classname:"className", cols:"cols", colspan:"colSpan", content:"content", contenteditable:"contentEditable", contextmenu:"contextMenu", controls:"controls", controlslist:"controlsList", coords:"coords", crossorigin:"crossOrigin", dangerouslysetinnerhtml:"dangerouslySetInnerHTML", data:"data", datetime:"dateTime", default:"default", defaultchecked:"defaultChecked", defaultvalue:"defaultValue", defer:"defer", dir:"dir", disabled:"disabled", 
    ...
    muted:"muted", name:"name", nomodule:"noModule", nonce:"nonce", novalidate:"noValidate", open:"open", optimum:"optimum", pattern:"pattern", placeholder:"placeholder", playsinline:"playsInline", poster:"poster", preload:"preload", profile:"profile", radiogroup:"radioGroup", readonly:"readOnly", referrerpolicy:"referrerPolicy", rel:"rel", required:"required", reversed:"reversed", role:"role", rows:"rows", rowspan:"rowSpan", sandbox:"sandbox", scope:"scope", scoped:"scoped", scrolling:"scrolling", 
    seamless:"seamless", selected:"selected", shape:"shape", size:"size", sizes:"sizes", span:"span", spellcheck:"spellCheck", src:"src", srcdoc:"srcDoc", srclang:"srcLang", srcset:"srcSet", start:"start", step:"step", style:"style", summary:"summary", tabindex:"tabIndex", target:"target", title:"title", type:"type", usemap:"useMap", value:"value", width:"width", wmode:"wmode", wrap:"wrap", about:"about", accentheight:"accentHeight", "accent-height":"accentHeight", accumulate:"accumulate", additive:"additive", 
    alignmentbaseline:"alignmentBaseline", "alignment-baseline":"alignmentBaseline", allowreorder:"allowReorder", alphabetic:"alphabetic", amplitude:"amplitude", arabicform:"arabicForm", "arabic-form":"arabicForm", ascent:"ascent", attributename:"attributeName", attributetype:"attributeType", autoreverse:"autoReverse", azimuth:"azimuth", basefrequency:"baseFrequency", baselineshift:"baselineShift", "baseline-shift":"baselineShift", baseprofile:"baseProfile", bbox:"bbox", begin:"begin", bias:"bias", 
    by:"by", calcmode:"calcMode", capheight:"capHeight", "cap-height":"capHeight", clip:"clip", clippath:"clipPath", "clip-path":"clipPath", clippathunits:"clipPathUnits", cliprule:"clipRule", "clip-rule":"clipRule", color:"color", colorinterpolation:"colorInterpolation", "color-interpolation":"colorInterpolation", colorinterpolationfilters:"colorInterpolationFilters", "color-interpolation-filters":"colorInterpolationFilters", colorprofile:"colorProfile", "color-profile":"colorProfile", colorrendering:"colorRendering", 
    ...
    "glyph-orientation-horizontal":"glyphOrientationHorizontal", glyphorientationvertical:"glyphOrientationVertical", "glyph-orientation-vertical":"glyphOrientationVertical", glyphref:"glyphRef", gradienttransform:"gradientTransform", gradientunits:"gradientUnits", hanging:"hanging", horizadvx:"horizAdvX", "horiz-adv-x":"horizAdvX", horizoriginx:"horizOriginX", "horiz-origin-x":"horizOriginX", ideographic:"ideographic", imagerendering:"imageRendering", "image-rendering":"imageRendering", in2:"in2", 
    in:"in", inlist:"inlist", intercept:"intercept", k1:"k1", k2:"k2", k3:"k3", k4:"k4", k:"k", kernelmatrix:"kernelMatrix", kernelunitlength:"kernelUnitLength", kerning:"kerning", keypoints:"keyPoints", keysplines:"keySplines", keytimes:"keyTimes", lengthadjust:"lengthAdjust", letterspacing:"letterSpacing", "letter-spacing":"letterSpacing", lightingcolor:"lightingColor", "lighting-color":"lightingColor", limitingconeangle:"limitingConeAngle", local:"local", markerend:"markerEnd", "marker-end":"markerEnd", 
    markerheight:"markerHeight", markermid:"markerMid", "marker-mid":"markerMid", markerstart:"markerStart", "marker-start":"markerStart", markerunits:"markerUnits", markerwidth:"markerWidth", mask:"mask", maskcontentunits:"maskContentUnits", maskunits:"maskUnits", mathematical:"mathematical", mode:"mode", numoctaves:"numOctaves", offset:"offset", opacity:"opacity", operator:"operator", order:"order", orient:"orient", orientation:"orientation", origin:"origin", overflow:"overflow", overlineposition:"overlinePosition", 
    ...
    prefix:"prefix", preservealpha:"preserveAlpha", preserveaspectratio:"preserveAspectRatio", primitiveunits:"primitiveUnits", property:"property", r:"r", radius:"radius", refx:"refX", refy:"refY", renderingintent:"renderingIntent", "rendering-intent":"renderingIntent", repeatcount:"repeatCount", repeatdur:"repeatDur", requiredextensions:"requiredExtensions", requiredfeatures:"requiredFeatures", resource:"resource", restart:"restart", result:"result", results:"results", rotate:"rotate", rx:"rx", 
    ry:"ry", scale:"scale", security:"security", seed:"seed", shaperendering:"shapeRendering", "shape-rendering":"shapeRendering", slope:"slope", spacing:"spacing", specularconstant:"specularConstant", specularexponent:"specularExponent", speed:"speed", spreadmethod:"spreadMethod", startoffset:"startOffset", stddeviation:"stdDeviation", stemh:"stemh", stemv:"stemv", stitchtiles:"stitchTiles", stopcolor:"stopColor", "stop-color":"stopColor", stopopacity:"stopOpacity", "stop-opacity":"stopOpacity", 
    ...
    strokemiterlimit:"strokeMiterlimit", "stroke-miterlimit":"strokeMiterlimit", strokewidth:"strokeWidth", "stroke-width":"strokeWidth", strokeopacity:"strokeOpacity", "stroke-opacity":"strokeOpacity", suppresscontenteditablewarning:"suppressContentEditableWarning", suppresshydrationwarning:"suppressHydrationWarning", surfacescale:"surfaceScale", systemlanguage:"systemLanguage", tablevalues:"tableValues", targetx:"targetX", targety:"targetY", textanchor:"textAnchor", "text-anchor":"textAnchor", 
    textdecoration:"textDecoration", "text-decoration":"textDecoration", textlength:"textLength", textrendering:"textRendering", "text-rendering":"textRendering", to:"to", transform:"transform", typeof:"typeof", u1:"u1", u2:"u2", underlineposition:"underlinePosition", "underline-position":"underlinePosition", underlinethickness:"underlineThickness", "underline-thickness":"underlineThickness", unicode:"unicode", unicodebidi:"unicodeBidi", "unicode-bidi":"unicodeBidi", unicoderange:"unicodeRange", 
    "unicode-range":"unicodeRange", unitsperem:"unitsPerEm", "units-per-em":"unitsPerEm", unselectable:"unselectable", valphabetic:"vAlphabetic", "v-alphabetic":"vAlphabetic", values:"values", vectoreffect:"vectorEffect", "vector-effect":"vectorEffect", version:"version", vertadvy:"vertAdvY", "vert-adv-y":"vertAdvY", vertoriginx:"vertOriginX", "vert-origin-x":"vertOriginX", vertoriginy:"vertOriginY", "vert-origin-y":"vertOriginY", vhanging:"vHanging", "v-hanging":"vHanging", videographic:"vIdeographic", 
    ...
    "xlink:arcrole":"xlinkArcrole", xlinkhref:"xlinkHref", "xlink:href":"xlinkHref", xlinkrole:"xlinkRole", "xlink:role":"xlinkRole", xlinkshow:"xlinkShow", "xlink:show":"xlinkShow", xlinktitle:"xlinkTitle", "xlink:title":"xlinkTitle", xlinktype:"xlinkType", "xlink:type":"xlinkType", xmlbase:"xmlBase", "xml:base":"xmlBase", xmllang:"xmlLang", "xml:lang":"xmlLang", xmlns:"xmlns", "xml:space":"xmlSpace", xmlnsxlink:"xmlnsXlink", "xmlns:xlink":"xmlnsXlink", xmlspace:"xmlSpace", y1:"y1", y2:"y2", y:"y", 
    ...
    warnedProperties = {}, rARIA = RegExp("^(aria)-[:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040]*$"), rARIACamel = RegExp("^(aria)[A-Z][:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040]*$"), 
    ...
    validateProperty$1 = function(tagName, name, value, canUseEventSystem) {
      ...
      if (canUseEventSystem) {
        ...
        canUseEventSystem = possibleRegistrationNames.hasOwnProperty(tagName) ? possibleRegistrationNames[tagName] : null;
        if (null != canUseEventSystem) {
          return error("Invalid event handler property `%s`. Did you mean `%s`?", name, canUseEventSystem), warnedProperties$1[name] = !0;
        }
      ...
      canUseEventSystem = getPropertyInfo(name);
      var isReserved = null !== canUseEventSystem && 0 === canUseEventSystem.type;
      ...
      } else if (!isReserved && name !== tagName) {
      ...
      if ("boolean" === typeof value && shouldRemoveAttributeWithWarning(name, value, canUseEventSystem, !1)) {
      ...
      if (shouldRemoveAttributeWithWarning(name, value, canUseEventSystem, !1)) {
        return warnedProperties$1[name] = !0, !1;
      }
      "false" !== value && "true" !== value || null === canUseEventSystem || 3 !== canUseEventSystem.type || (error("Received the string `%s` for the boolean attribute `%s`. %s Did you mean %s\x3d{%s}?", value, name, "false" === value ? "The browser will interpret it as a truthy value." : 'Although this works, it will not work as expected if you pass the string "false".', name, value), warnedProperties$1[name] = !0);
      return !0;
    };
    var warnUnknownProperties = function(type, props, canUseEventSystem) {
      ...
      1 === unknownProps.length ? error("Invalid value for prop %s on \x3c%s\x3e tag. Either remove it from the element, or pass a string or number value to keep it in the DOM. For details, see https://fb.me/react-attribute-behavior", props, type) : 1 < unknownProps.length && error("Invalid values for props %s on \x3c%s\x3e tag. Either remove them from the element, or pass a string or number value to keep them in the DOM. For details, see https://fb.me/react-attribute-behavior", props, type);
    }, didWarnInvalidHydration = !1, suppressHydrationWarning;
    var warnedUnknownTags = {time:!0, dialog:!0, webview:!0};
    var validatePropertiesInDevelopment = function(type, props) {
      ...
      type));
      isCustomComponent(type, props) || warnUnknownProperties(type, props, !0);
    };
    ...
    var SUSPENSE_START_DATA = "$", SUSPENSE_END_DATA = "/$", SUSPENSE_PENDING_START_DATA = "$?", SUSPENSE_FALLBACK_START_DATA = "$!", eventsEnabled = null, selectionInformation = null, scheduleTimeout = "function" === typeof setTimeout ? setTimeout : void 0, cancelTimeout = "function" === typeof clearTimeout ? clearTimeout : void 0, randomKey = Math.random().toString(36).slice(2), internalInstanceKey = "__reactInternalInstance$" + randomKey, internalEventHandlersKey = "__reactEventHandlers$" + randomKey, 
    internalContainerInstanceKey = "__reactContainere$" + randomKey, root = null, startText = null, fallbackText = null;
    _assign(SyntheticEvent.prototype, {preventDefault:function() {
    ...
    SyntheticEvent.Interface = {type:null, target:null, currentTarget:function() {
      return null;
    ...
    var SyntheticCompositionEvent = SyntheticEvent.extend({data:null}), SyntheticInputEvent = SyntheticEvent.extend({data:null}), END_KEYCODES = [9, 13, 27, 32], canUseCompositionEvent = canUseDOM && "CompositionEvent" in window, documentMode = null;
    ...
    isComposing = !1, BeforeInputEventPlugin = {eventTypes, extractEvents:function(topLevelType, targetInst, nativeEvent, nativeEventTarget, eventSystemFlags) {
      ...
      if (canUseCompositionEvent) {
        ...
        isComposing ? isFallbackCompositionEnd(topLevelType, nativeEvent) && (eventType = eventTypes.compositionEnd) : "keydown" === topLevelType && 229 === nativeEvent.keyCode && (eventType = eventTypes.compositionStart);
      }
      eventType ? (useFallbackCompositionData && "ko" !== nativeEvent.locale && (isComposing || eventType !== eventTypes.compositionStart ? eventType === eventTypes.compositionEnd && isComposing && (composition = getData()) : (root = nativeEventTarget, startText = "value" in root ? root.value : root.textContent, isComposing = !0)), eventSystemFlags = SyntheticCompositionEvent.getPooled(eventType, targetInst, nativeEvent, nativeEventTarget), composition ? eventSystemFlags.data = composition : (composition = 
      getDataFromCustomEvent(nativeEvent), null !== composition && (eventSystemFlags.data = composition)), accumulateTwoPhaseDispatches(eventSystemFlags), composition = eventSystemFlags) : composition = null;
    ...
    }}, supportedInputTypes = {color:!0, date:!0, datetime:!0, "datetime-local":!0, email:!0, month:!0, number:!0, password:!0, range:!0, search:!0, tel:!0, text:!0, time:!0, url:!0, week:!0}, eventTypes$1 = {change:{phasedRegistrationNames:{bubbled:"onChange", captured:"onChangeCapture"}, dependencies:"blur change click focus input keydown keyup selectionchange".split(" ")}}, activeElement = null, activeElementInst = null, isInputEventSupported = !1;
    canUseDOM && (isInputEventSupported = isEventSupported("input") && (!document.documentMode || 9 < document.documentMode));
    var ChangeEventPlugin = {eventTypes:eventTypes$1, _isInputEventSupported:isInputEventSupported, extractEvents:function(topLevelType, targetInst, nativeEvent, nativeEventTarget, eventSystemFlags) {
      eventSystemFlags = targetInst ? getNodeFromInstance$1(targetInst) : window;
      var nodeName = eventSystemFlags.nodeName && eventSystemFlags.nodeName.toLowerCase();
      if ("select" === nodeName || "input" === nodeName && "file" === eventSystemFlags.type) {
        var getTargetInstFunc = getTargetInstForChangeEvent;
      } else if (isTextInputElement(eventSystemFlags)) {
        ...
        (nodeName = eventSystemFlags.nodeName) && "input" === nodeName.toLowerCase() && ("checkbox" === eventSystemFlags.type || "radio" === eventSystemFlags.type) && (getTargetInstFunc = getTargetInstForClickEvent);
      }
      if (getTargetInstFunc && (getTargetInstFunc = getTargetInstFunc(topLevelType, targetInst))) {
        return createAndAccumulateChangeEvent(getTargetInstFunc, nativeEvent, nativeEventTarget);
      }
      handleEventFunc && handleEventFunc(topLevelType, eventSystemFlags, targetInst);
      "blur" === topLevelType && (topLevelType = eventSystemFlags._wrapperState) && topLevelType.controlled && "number" === eventSystemFlags.type && setDefaultValue(eventSystemFlags, "number", eventSystemFlags.value);
    }}, SyntheticUIEvent = SyntheticEvent.extend({view:null, detail:null}), modifierKeyToProp = {Alt:"altKey", Control:"ctrlKey", Meta:"metaKey", Shift:"shiftKey"}, previousScreenX = 0, previousScreenY = 0, isMovementXSet = !1, isMovementYSet = !1, SyntheticMouseEvent = SyntheticUIEvent.extend({screenX:null, screenY:null, clientX:null, clientY:null, pageX:null, pageY:null, ctrlKey:null, shiftKey:null, altKey:null, metaKey:null, getModifierState:getEventModifierState, button:null, buttons:null, relatedTarget:function(event) {
    ...
    dependencies:["pointerout", "pointerover"]}}, EnterLeaveEventPlugin = {eventTypes:eventTypes$2, extractEvents:function(topLevelType, targetInst, nativeEvent, nativeEventTarget, eventSystemFlags) {
      ...
      if (isOutEvent) {
        if (isOutEvent = targetInst, targetInst = (targetInst = nativeEvent.relatedTarget || nativeEvent.toElement) ? getClosestInstanceFromNode(targetInst) : null, null !== targetInst) {
          var nearestMounted = getNearestMountedFiber(targetInst);
          if (targetInst !== nearestMounted || 5 !== targetInst.tag && 6 !== targetInst.tag) {
            targetInst = null;
          }
        }
      } else {
      ...
      if ("mouseout" === topLevelType || "mouseover" === topLevelType) {
        ...
        eventInterface = SyntheticPointerEvent, leaveEventType = eventTypes$2.pointerLeave, enterEventType = eventTypes$2.pointerEnter, eventTypePrefix = "pointer";
      }
      ...
      if (nativeEventTarget && eventTypePrefix) {
        a: {
          ...
          isOutEvent = 0;
          for (topLevelType = eventInterface; topLevelType; topLevelType = getParent(topLevelType)) {
            isOutEvent++;
          }
          topLevelType = 0;
          for (targetInst = enterEventType; targetInst; targetInst = getParent(targetInst)) {
            topLevelType++;
          }
          ...
          for (; isOutEvent--;) {
            if (eventInterface === enterEventType || eventInterface === enterEventType.alternate) {
              break a;
            }
      ...
      for (eventInterface = []; nativeEventTarget && nativeEventTarget !== enterEventType;) {
        ...
        if (null !== isOutEvent && isOutEvent === enterEventType) {
          break;
        }
      ...
      for (eventTypePrefix = 0; eventTypePrefix < eventInterface.length; eventTypePrefix++) {
        accumulateDispatches(eventInterface[eventTypePrefix], "bubbled", leaveEventType);
      }
      for (eventTypePrefix = nativeEventTarget.length; 0 < eventTypePrefix--;) {
        accumulateDispatches(nativeEventTarget[eventTypePrefix], "captured", nativeEvent);
      }
      return 0 === (eventSystemFlags & 64) ? [leaveEventType] : [leaveEventType, nativeEvent];
    }}, objectIs = "function" === typeof Object.is ? Object.is : is, hasOwnProperty$2 = Object.prototype.hasOwnProperty, skipSelectionChangeEvent = canUseDOM && "documentMode" in document && 11 >= document.documentMode, eventTypes$3 = {select:{phasedRegistrationNames:{bubbled:"onSelect", captured:"onSelectCapture"}, dependencies:"blur contextmenu dragend focus keydown keyup mousedown mouseup selectionchange".split(" ")}}, activeElement$1 = null, activeElementInst$1 = null, lastSelection = null, mouseDown = 
    !1, SelectEventPlugin = {eventTypes:eventTypes$3, extractEvents:function(topLevelType, targetInst, nativeEvent, nativeEventTarget, eventSystemFlags, container) {
      ...
      switch(topLevelType) {
        case "focus":
          if (isTextInputElement(eventSystemFlags) || "true" === eventSystemFlags.contentEditable) {
            activeElement$1 = eventSystemFlags, activeElementInst$1 = targetInst, lastSelection = null;
          }
          break;
        case "blur":
      ...
      return null;
    }}, SyntheticAnimationEvent = SyntheticEvent.extend({animationName:null, elapsedTime:null, pseudoElement:null}), SyntheticClipboardEvent = SyntheticEvent.extend({clipboardData:function(event) {
      return "clipboardData" in event ? event.clipboardData : window.clipboardData;
    }}), SyntheticFocusEvent = SyntheticUIEvent.extend({relatedTarget:null}), normalizeKey = {Esc:"Escape", Spacebar:" ", Left:"ArrowLeft", Up:"ArrowUp", Right:"ArrowRight", Down:"ArrowDown", Del:"Delete", Win:"OS", Menu:"ContextMenu", Apps:"ContextMenu", Scroll:"ScrollLock", MozPrintableKey:"Unidentified"}, translateToKey = {8:"Backspace", 9:"Tab", 12:"Clear", 13:"Enter", 16:"Shift", 17:"Control", 18:"Alt", 19:"Pause", 20:"CapsLock", 27:"Escape", 32:" ", 33:"PageUp", 34:"PageDown", 35:"End", 36:"Home", 
    37:"ArrowLeft", 38:"ArrowUp", 39:"ArrowRight", 40:"ArrowDown", 45:"Insert", 46:"Delete", 112:"F1", 113:"F2", 114:"F3", 115:"F4", 116:"F5", 117:"F6", 118:"F7", 119:"F8", 120:"F9", 121:"F10", 122:"F11", 123:"F12", 144:"NumLock", 145:"ScrollLock", 224:"Meta"}, SyntheticKeyboardEvent = SyntheticUIEvent.extend({key:function(nativeEvent) {
      if (nativeEvent.key) {
    ...
    }, location:null, ctrlKey:null, shiftKey:null, altKey:null, metaKey:null, repeat:null, locale:null, getModifierState:getEventModifierState, charCode:function(event) {
    ...
    }, deltaZ:null, deltaMode:null}), knownHTMLTopLevelTypes = "abort cancel canplay canplaythrough close durationchange emptied encrypted ended error input invalid load loadeddata loadedmetadata loadstart pause play playing progress ratechange reset seeked seeking stalled submit suspend timeupdate toggle volumechange waiting".split(" "), SimpleEventPlugin = {eventTypes:simpleEventPluginEventTypes, extractEvents:function(topLevelType, targetInst, nativeEvent, nativeEventTarget, eventSystemFlags) {
      eventSystemFlags = topLevelEventsToDispatchConfig.get(topLevelType);
      if (!eventSystemFlags) {
        return null;
      }
      switch(topLevelType) {
        ...
        case "pointerup":
          ...
          break;
        default:
          -1 === knownHTMLTopLevelTypes.indexOf(topLevelType) && error("SimpleEventPlugin: Unhandled event type, `%s`. This warning is likely caused by a bug in React. Please file an issue.", topLevelType), topLevelType = SyntheticEvent;
      }
      targetInst = topLevelType.getPooled(eventSystemFlags, targetInst, nativeEvent, nativeEventTarget);
    ...
    (function(getFiberCurrentPropsFromNodeImpl, getInstanceFromNodeImpl, getNodeFromInstanceImpl) {
      ...
      (getNodeFromInstance = getNodeFromInstanceImpl) && getInstanceFromNode || error("EventPluginUtils.setComponentTree(...): Injected module is missing getNodeFromInstance or getInstanceFromNode.");
    })(getFiberCurrentPropsFromNode$1, getInstanceFromNode$1, getNodeFromInstance$1);
    injectEventPluginsByName({SimpleEventPlugin, EnterLeaveEventPlugin, ChangeEventPlugin, SelectEventPlugin, BeforeInputEventPlugin});
    var supportsUserTiming = "undefined" !== typeof performance && "function" === typeof performance.mark && "function" === typeof performance.clearMarks && "function" === typeof performance.measure && "function" === typeof performance.clearMeasures, currentFiber = null, currentPhase = null, currentPhaseFiber = null, isCommitting = !1, hasScheduledUpdateInCurrentCommit = !1, hasScheduledUpdateInCurrentPhase = !1, commitCountInCurrentWorkLoop = 0, effectCountInCurrentCommit = 0, labelsInCurrentCommit = 
    new Set(), beginMark = function(markName) {
      performance.mark("⚛ " + markName);
    }, endMark = function(label, markName, warning) {
      markName = "⚛ " + markName;
      label = (warning ? "⛔ " : "⚛ ") + label + (warning ? " Warning: " + warning : "");
      try {
      ...
      var componentName = getComponentName(fiber.type) || "Unknown", debugID = fiber._debugID;
      fiber = getFiberLabel(componentName, null !== fiber.alternate, phase);
      if (isCommitting && labelsInCurrentCommit.has(fiber)) {
        return !1;
      }
      ...
      var componentName = getComponentName(fiber.type) || "Unknown", debugID = fiber._debugID;
      fiber = getFiberLabel(componentName, null !== fiber.alternate, phase) + " (#" + debugID + ")";
    ...
    }, syncQueue = null, immediateQueueCallbackNode = null, isFlushingSyncQueue = !1, initialTimeMs = Scheduler_now(), now = 10000 > initialTimeMs ? Scheduler_now : function() {
    ...
    ReactStrictModeWarnings.flushPendingUnsafeLifecycleWarnings = function() {
      ...
      0 < UNSAFE_componentWillReceivePropsUniqueNames.size && (sortedNames = setToSortedString(UNSAFE_componentWillReceivePropsUniqueNames), error("Using UNSAFE_componentWillReceiveProps in strict mode is not recommended and may indicate bugs in your code. See https://fb.me/react-unsafe-component-lifecycles for details.\n\n* Move data fetching code or side effects to componentDidUpdate.\n* If you're updating state whenever props change, refactor your code to use memoization techniques or move it to static getDerivedStateFromProps. Learn more at: https://fb.me/react-derived-state\n\nPlease update the following components: %s", 
      sortedNames));
      0 < UNSAFE_componentWillUpdateUniqueNames.size && (sortedNames = setToSortedString(UNSAFE_componentWillUpdateUniqueNames), error("Using UNSAFE_componentWillUpdate in strict mode is not recommended and may indicate bugs in your code. See https://fb.me/react-unsafe-component-lifecycles for details.\n\n* Move data fetching code or side effects to componentDidUpdate.\n\nPlease update the following components: %s", sortedNames));
      0 < componentWillMountUniqueNames.size && (sortedNames = setToSortedString(componentWillMountUniqueNames), warn("componentWillMount has been renamed, and is not recommended for use. See https://fb.me/react-unsafe-component-lifecycles for details.\n\n* Move code with side effects to componentDidMount, and set initial state in the constructor.\n* Rename componentWillMount to UNSAFE_componentWillMount to suppress this warning in non-strict mode. In React 17.x, only the UNSAFE_ name will work. To rename all deprecated lifecycles to their new names, you can run `npx react-codemod rename-unsafe-lifecycles` in your project source folder.\n\nPlease update the following components: %s", 
      sortedNames));
      0 < componentWillReceivePropsUniqueNames.size && (sortedNames = setToSortedString(componentWillReceivePropsUniqueNames), warn("componentWillReceiveProps has been renamed, and is not recommended for use. See https://fb.me/react-unsafe-component-lifecycles for details.\n\n* Move data fetching code or side effects to componentDidUpdate.\n* If you're updating state whenever props change, refactor your code to use memoization techniques or move it to static getDerivedStateFromProps. Learn more at: https://fb.me/react-derived-state\n* Rename componentWillReceiveProps to UNSAFE_componentWillReceiveProps to suppress this warning in non-strict mode. In React 17.x, only the UNSAFE_ name will work. To rename all deprecated lifecycles to their new names, you can run `npx react-codemod rename-unsafe-lifecycles` in your project source folder.\n\nPlease update the following components: %s", 
      sortedNames));
      0 < componentWillUpdateUniqueNames.size && (sortedNames = setToSortedString(componentWillUpdateUniqueNames), warn("componentWillUpdate has been renamed, and is not recommended for use. See https://fb.me/react-unsafe-component-lifecycles for details.\n\n* Move data fetching code or side effects to componentDidUpdate.\n* Rename componentWillUpdate to UNSAFE_componentWillUpdate to suppress this warning in non-strict mode. In React 17.x, only the UNSAFE_ name will work. To rename all deprecated lifecycles to their new names, you can run `npx react-codemod rename-unsafe-lifecycles` in your project source folder.\n\nPlease update the following components: %s", 
      sortedNames));
    };
    ...
    ReactStrictModeWarnings.flushLegacyContextWarning = function() {
      pendingLegacyContextWarning.forEach(function(fiberArray, strictRoot) {
        if (0 !== fiberArray.length) {
          ...
          strictRoot = getStackByFiberInDevAndProd(strictRoot);
          error("Legacy context API has been detected within a strict-mode tree.\n\nThe old API will be supported in all 16.x releases, but applications using it should migrate to the new version.\n\nPlease update the following components: %s\n\nLearn more about this warning here: https://fb.me/react-legacy-context%s", fiberArray, strictRoot);
        }
      });
    };
    ...
    var resolveFamily = null, failedBoundaries = null, setRefreshHandler = function(handler) {
      ...
      root.context === emptyContextObject && (flushPassiveEffects(), syncUpdates(function() {
    ...
    var rendererSigil = {};
    var currentlyRenderingFiber = null, lastContextDependency = null, lastContextWithAllBitsObserved = null, isDisallowedContextReadInDEV = !1, UpdateState = 0, ForceUpdate = 2, CaptureUpdate = 3, hasForceUpdate = !1;
    var didWarnUpdateInsideUpdate = !1;
    var currentlyProcessingQueue = null;
    var ReactCurrentBatchConfig = ReactSharedInternals.ReactCurrentBatchConfig, fakeInternalInstance = {}, isArray = Array.isArray, emptyRefsObject = (new React.Component()).refs;
    ...
    var classComponentUpdater = {isMounted:function(component) {
      ...
      var currentTime = requestCurrentTimeForUpdate(), suspenseConfig = ReactCurrentBatchConfig.suspense;
      ...
      void 0 !== callback && null !== callback && (warnOnInvalidCallback(callback, "setState"), suspenseConfig.callback = callback);
      ...
      suspenseConfig.payload = payload;
      void 0 !== callback && null !== callback && (warnOnInvalidCallback(callback, "replaceState"), suspenseConfig.callback = callback);
      enqueueUpdate(inst, suspenseConfig);
      scheduleWork(inst, currentTime);
      ...
      void 0 !== callback && null !== callback && (warnOnInvalidCallback(callback, "forceUpdate"), suspenseConfig.callback = callback);
      enqueueUpdate(inst, suspenseConfig);
      scheduleWork(inst, currentTime);
    }}, didWarnAboutMaps, warnForMissingKey = function(child) {
    };
    ...
    warnForMissingKey = function(child) {
      if (null !== child && "object" === typeof child && child._store && !child._store.validated && null == child.key) {
        ...
        child = 'Each child in a list should have a unique "key" prop. See https://fb.me/react-warning-keys for more information.' + getCurrentFiberStackInDev();
        ownerHasKeyUseWarning[child] || (ownerHasKeyUseWarning[child] = !0, error('Each child in a list should have a unique "key" prop. See https://fb.me/react-warning-keys for more information.'));
      }
    };
    ...
    null, InvalidNestedHooksDispatcherOnRerenderInDEV = null, warnInvalidContextAccess = function() {
    ...
    HooksDispatcherOnUpdateInDEV = {readContext:function(context, observedBits) {
      ...
      currentHookNameInDev = "useState";
      updateHookTypesDev();
      initialState = ReactCurrentDispatcher.current;
      ReactCurrentDispatcher.current = InvalidNestedHooksDispatcherOnUpdateInDEV;
      try {
        return updateReducer(basicStateReducer);
      } finally {
        ReactCurrentDispatcher.current = initialState;
      }
    }, useDebugValue:function(value, formatterFn) {
      currentHookNameInDev = "useDebugValue";
      updateHookTypesDev();
    ...
    var now$1 = Scheduler.unstable_now, commitTime = 0, profilerStartTime = -1, hydrationParentFiber = null, nextHydratableInstance = null, isHydrating = !1, ReactCurrentOwner$1 = ReactSharedInternals.ReactCurrentOwner, didReceiveUpdate = !1;
    ...
    var SUSPENDED_MARKER = {dehydrated:null, retryTime:0}, hasWarnedAboutUsingContextAsConsumer = !1;
    ...
    var updateHostComponent$1 = function(current, workInProgress, type, newProps, rootContainerInstance) {
      ...
      if (oldProps !== newProps) {
        var instance = workInProgress.stateNode, currentHostContext = requiredContext(contextStackCursor$1.current);
          ...
          if (!newProps.hasOwnProperty(propKey) && oldProps.hasOwnProperty(propKey) && null != oldProps[propKey]) {
            if ("style" === propKey) {
              for (styleName in instance = oldProps[propKey], instance) {
                instance.hasOwnProperty(styleName) && (type || (type = {}), type[styleName] = "");
              }
            } else {
              "dangerouslySetInnerHTML" !== propKey && "children" !== propKey && "suppressContentEditableWarning" !== propKey && "suppressHydrationWarning" !== propKey && "autoFocus" !== propKey && (registrationNameModules.hasOwnProperty(propKey) ? current || (current = []) : (current = current || []).push(propKey, null));
            }
          }
        }
        for (propKey in newProps) {
          if (currentHostContext = newProps[propKey], instance = null != oldProps ? oldProps[propKey] : void 0, newProps.hasOwnProperty(propKey) && currentHostContext !== instance && (null != currentHostContext || null != instance)) {
            if ("style" === propKey) {
              if (currentHostContext && Object.freeze(currentHostContext), instance) {
                for (styleName in instance) {
                  !instance.hasOwnProperty(styleName) || currentHostContext && currentHostContext.hasOwnProperty(styleName) || (type || (type = {}), type[styleName] = "");
                }
                for (styleName in currentHostContext) {
                  currentHostContext.hasOwnProperty(styleName) && instance[styleName] !== currentHostContext[styleName] && (type || (type = {}), type[styleName] = currentHostContext[styleName]);
                }
              } else {
                type || (current || (current = []), current.push(propKey, type)), type = currentHostContext;
              }
            } else {
              "dangerouslySetInnerHTML" === propKey ? (currentHostContext = currentHostContext ? currentHostContext.__html : void 0, instance = instance ? instance.__html : void 0, null != currentHostContext && instance !== currentHostContext && (current = current || []).push(propKey, currentHostContext)) : "children" === propKey ? instance === currentHostContext || "string" !== typeof currentHostContext && "number" !== typeof currentHostContext || (current = current || []).push(propKey, "" + currentHostContext) : 
              "suppressContentEditableWarning" !== propKey && "suppressHydrationWarning" !== propKey && (registrationNameModules.hasOwnProperty(propKey) ? (null != currentHostContext && ("function" !== typeof currentHostContext && warnForInvalidEventListener(propKey, currentHostContext), ensureListeningTo(rootContainerInstance, propKey)), current || instance === currentHostContext || (current = [])) : (current = current || []).push(propKey, currentHostContext));
            }
          }
        }
        if (type) {
          rootContainerInstance = type;
          if (styleName = newProps.style) {
            var propKey = expandShorthandMap(rootContainerInstance);
            styleName = expandShorthandMap(styleName);
            oldProps = {};
            for (updatePayload in propKey) {
              newProps = propKey[updatePayload], (instance = styleName[updatePayload]) && newProps !== instance && (currentHostContext = newProps + "," + instance, oldProps[currentHostContext] || (oldProps[currentHostContext] = !0, currentHostContext = rootContainerInstance[newProps], error("%s a style property during rerender (%s) when a conflicting property is set (%s) can lead to styling bugs. To avoid this, don't mix shorthand and non-shorthand properties for the same value; instead, replace the shorthand with separate values.", 
              null == currentHostContext || "boolean" === typeof currentHostContext || "" === currentHostContext ? "Removing" : "Updating", newProps, instance)));
            }
          }
    ...
    var PossiblyWeakSet = "function" === typeof WeakSet ? WeakSet : Set, callComponentWillUnmountWithTimer = function(current, instance) {
      ...
      stopPhaseTimer();
    }, PossiblyWeakMap$1 = "function" === typeof WeakMap ? WeakMap : Map, ceil = Math.ceil, ReactCurrentDispatcher$1 = ReactSharedInternals.ReactCurrentDispatcher, ReactCurrentOwner$2 = ReactSharedInternals.ReactCurrentOwner, IsSomeRendererActing = ReactSharedInternals.IsSomeRendererActing, NoContext = 0, BatchedContext = 1, LegacyUnbatchedContext = 8, RenderContext = 16, CommitContext = 32, RootIncomplete = 0, RootFatalErrored = 1, RootErrored = 2, RootSuspended = 3, RootSuspendedWithDelay = 4, 
    RootCompleted = 5, executionContext = NoContext, workInProgressRoot = null, workInProgress = null, renderExpirationTime$1 = 0, workInProgressRootExitStatus = RootIncomplete, workInProgressRootFatalError = null, workInProgressRootLatestProcessedExpirationTime = 1073741823, workInProgressRootLatestSuspenseTimeout = 1073741823, workInProgressRootCanSuspendUsingConfig = null, workInProgressRootNextUnprocessedUpdateTime = 0, workInProgressRootHasPendingPing = !1, globalMostRecentFallbackTime = 0, 
    FALLBACK_THROTTLE_MS = 500, nextEffect = null, hasUncaughtError = !1, firstUncaughtError = null, legacyErrorBoundariesThatAlreadyFailed = null, rootDoesHavePassiveEffects = !1, rootWithPendingPassiveEffects = null, pendingPassiveEffectsRenderPriority = 90, pendingPassiveEffectsExpirationTime = 0, rootsWithPendingDiscreteUpdates = null, nestedUpdateCount = 0, rootWithNestedUpdates = null, nestedPassiveUpdateCount = 0, interruptedBy = null, spawnedWorkDuringRender = null, currentEventTime = 0, 
    scheduleWork = function(fiber, expirationTime) {
      ...
      50 < nestedPassiveUpdateCount && (nestedPassiveUpdateCount = 0, error("Maximum update depth exceeded. This can happen when a component calls setState inside useEffect, but useEffect either doesn't have a dependency array, or one of the dependencies changes on every render."));
      ...
      renderingComponentName = markUpdateTimeFromFiberToRoot(fiber, expirationTime);
      if (null === renderingComponentName) {
        a: {
          if (expirationTime = fiber.tag, 3 === expirationTime || 1 === expirationTime || 0 === expirationTime || 11 === expirationTime || 14 === expirationTime || 15 === expirationTime || 22 === expirationTime) {
            renderingComponentName = getComponentName(fiber.type) || "ReactComponent";
            if (null !== didWarnStateUpdateForUnmountedComponent) {
              if (didWarnStateUpdateForUnmountedComponent.has(renderingComponentName)) {
                break a;
              }
              didWarnStateUpdateForUnmountedComponent.add(renderingComponentName);
            } else {
              didWarnStateUpdateForUnmountedComponent = new Set([renderingComponentName]);
            }
            error("Can't perform a React state update on an unmounted component. This is a no-op, but it indicates a memory leak in your application. To fix, cancel all subscriptions and asynchronous tasks in %s.%s", 1 === expirationTime ? "the componentWillUnmount method" : "a useEffect cleanup function", getStackByFiberInDevAndProd(fiber));
          }
        }
      } else {
        null !== workInProgressRoot && expirationTime > renderExpirationTime$1 && (interruptedBy = fiber), isCommitting && (hasScheduledUpdateInCurrentCommit = !0), null !== currentPhase && "componentWillMount" !== currentPhase && "componentWillReceiveProps" !== currentPhase && (hasScheduledUpdateInCurrentPhase = !0), fiber = getCurrentPriorityLevel(), 1073741823 === expirationTime ? (executionContext & LegacyUnbatchedContext) !== NoContext && (executionContext & (RenderContext | CommitContext)) === 
        NoContext ? (schedulePendingInteractions(renderingComponentName, expirationTime), performSyncWorkOnRoot(renderingComponentName)) : (ensureRootIsScheduled(renderingComponentName), schedulePendingInteractions(renderingComponentName, expirationTime), executionContext === NoContext && flushSyncCallbackQueue()) : (ensureRootIsScheduled(renderingComponentName), schedulePendingInteractions(renderingComponentName, expirationTime)), (executionContext & 4) === NoContext || 98 !== fiber && 99 !== fiber || 
        (null === rootsWithPendingDiscreteUpdates ? rootsWithPendingDiscreteUpdates = new Map([[renderingComponentName, expirationTime]]) : (fiber = rootsWithPendingDiscreteUpdates.get(renderingComponentName), (void 0 === fiber || fiber > expirationTime) && rootsWithPendingDiscreteUpdates.set(renderingComponentName, expirationTime)));
      }
    }, didWarnStateUpdateForUnmountedComponent = null;
    var beginWork$1 = function(current, unitOfWork, expirationTime) {
    ...
    var IsThisRendererActing = {current:!1}, didWarnAboutUnmockedScheduler = !1, onScheduleFiberRoot = null, onCommitFiberRoot = null, onCommitFiberUnmount = null, hasLoggedError = !1, isDevToolsPresent = "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__;
    ...
    var shouldSuspendImpl = function(fiber) {
      return !1;
    }, overrideHookState = null, overrideProps = null, scheduleUpdate = null, setSuspenseHandler = null, copyWithSetImpl = function(obj, path, idx, value) {
      if (idx >= path.length) {
        return value;
      }
      var key = path[idx], updated = Array.isArray(obj) ? obj.slice() : _assign({}, obj);
      updated[key] = copyWithSetImpl(obj[key], path, idx + 1, value);
      return updated;
    };
    overrideHookState = function(fiber, id, path, value) {
      for (var currentHook = fiber.memoizedState; null !== currentHook && 0 < id;) {
        currentHook = currentHook.next, id--;
      }
      null !== currentHook && (id = copyWithSetImpl(currentHook.memoizedState, path, 0, value), currentHook.memoizedState = id, currentHook.baseState = id, fiber.memoizedProps = _assign({}, fiber.memoizedProps), scheduleWork(fiber, 1073741823));
    };
    ...
    var topLevelUpdateWarnings = function(container) {
      ...
      rootEl && getInstanceFromNode$1(rootEl) && !hostInstance && error("render(...): Replacing React-rendered children with a new root component. If you intended to update the children of this node, you should instead have the existing children update their state and render the new components instead of calling ReactDOM.render.");
    ...
    var attemptUserBlockingHydration = function(fiber) {
      if (13 === fiber.tag) {
        var expTime = computeExpirationBucket(requestCurrentTimeForUpdate(), 500, 100);
    ...
    "function" === typeof Map && null != Map.prototype && "function" === typeof Map.prototype.forEach && "function" === typeof Set && null != Set.prototype && "function" === typeof Set.prototype.clear && "function" === typeof Set.prototype.forEach || error("React depends on Map and Set built-in types. Make sure that you load a polyfill in older browsers. https://fb.me/react-polyfills");
    ...
    (function(_batchedUpdatesImpl, _discreteUpdatesImpl, _flushDiscreteUpdatesImpl, _batchedEventUpdatesImpl) {
      ...
      (executionContext & (BatchedContext | RenderContext | CommitContext)) !== NoContext ? (executionContext & RenderContext) !== NoContext && error("unstable_flushDiscreteUpdates: Cannot flush updates when React is already rendering.") : (flushPendingDiscreteUpdates(), flushPassiveEffects());
    }, function(fn, a) {
      var prevExecutionContext = executionContext;
      executionContext |= 2;
      try {
    ...
    var Internals = {Events:[getInstanceFromNode$1, getNodeFromInstance$1, getFiberCurrentPropsFromNode$1, injectEventPluginsByName, eventNameDispatchConfigs, accumulateTwoPhaseDispatches, function(events) {
      forEachAccumulated(events, accumulateDirectDispatchesSingle);
    }, enqueueStateRestore, restoreStateIfNeeded, dispatchEvent, runEventsInBatch, flushPassiveEffects, IsThisRendererActing]};
    if (!function(devToolsConfig) {
      var findFiberByHostInstance = devToolsConfig.findFiberByHostInstance;
      return injectInternals(_assign({}, devToolsConfig, {overrideHookState, overrideProps, setSuspenseHandler, scheduleUpdate, currentDispatcherRef:ReactSharedInternals.ReactCurrentDispatcher, findHostInstanceByFiber:function(fiber) {
        fiber = findCurrentHostFiber(fiber);
        return null === fiber ? null : fiber.stateNode;
      }, findFiberByHostInstance:function(instance) {
        return findFiberByHostInstance ? findFiberByHostInstance(instance) : null;
      }, findHostInstancesForRefresh, scheduleRefresh, scheduleRoot, setRefreshHandler, getCurrentFiber:function() {
        return current;
      }}));
    }({findFiberByHostInstance:getClosestInstanceFromNode, bundleType:1, version:"16.14.0", rendererPackageName:"react-dom"}) && canUseDOM && window.top === window.self && (-1 < navigator.userAgent.indexOf("Chrome") && -1 === navigator.userAgent.indexOf("Edge") || -1 < navigator.userAgent.indexOf("Firefox"))) {
    ...
    exports.findDOMNode = function(componentOrElement) {
      ...
      if (null === componentOrElement) {
        ...
        if (componentOrElement.mode & 1) {
          ...
          didWarnAboutFindNodeInStrictMode[componentName] || (didWarnAboutFindNodeInStrictMode[componentName] = !0, owner.mode & 1 ? error("%s is deprecated in StrictMode. %s was passed an instance of %s which is inside StrictMode. Instead, add a ref directly to the element you want to reference. Learn more about using refs safely here: https://fb.me/react-strict-mode-find-node%s", "findDOMNode", "findDOMNode", componentName, getStackByFiberInDevAndProd(componentOrElement)) : error("%s is deprecated in StrictMode. %s was passed an instance of %s which renders StrictMode children. Instead, add a ref directly to the element you want to reference. Learn more about using refs safely here: https://fb.me/react-strict-mode-find-node%s", 
          "findDOMNode", "findDOMNode", componentName, getStackByFiberInDevAndProd(componentOrElement)));
        }
    ...
    exports.unmountComponentAtNode = function(container) {
      ...
      if (container._reactRootContainer) {
        var rootEl = getReactRootElementInContainer(container);
        rootEl && !getInstanceFromNode$1(rootEl) && error("unmountComponentAtNode(): The node you're attempting to unmount was rendered by another copy of React.");
        unbatchedUpdates(function() {
      ...
      rootEl = !(!rootEl || !getInstanceFromNode$1(rootEl));
    ...
    exports.unstable_createPortal = function(children, container) {
      var key = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : null;
      didWarnAboutUnstableCreatePortal || (didWarnAboutUnstableCreatePortal = !0, warn('The ReactDOM.unstable_createPortal() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactDOM.createPortal() instead. It has the exact same API, but without the "unstable_" prefix.'));
    ...
    exports.unstable_renderSubtreeIntoContainer = function(parentComponent, element, containerNode, callback) {
      ...
      if (null == parentComponent || void 0 === parentComponent._reactInternalFiber) {
