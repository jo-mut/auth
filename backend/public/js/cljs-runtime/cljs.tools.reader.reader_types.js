...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_15071 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_15071(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_15080 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_15080(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_15081 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_15081(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_15086 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_15086(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_15087 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_15087(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_15092 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_15092(reader);
}
});
...
var G__15205 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__15206 = s.append(c);
c = G__15205;
s = G__15206;
continue;
}
