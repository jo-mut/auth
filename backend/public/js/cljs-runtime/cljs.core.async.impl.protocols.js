...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_15443 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_15443(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_15444 = (function (port,val,fn1_handler){
var x__5350__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_15444(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_15459 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_15459(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_15467 = (function (chan){
var x__5350__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_15467(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_15469 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_15469(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_15476 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_15476(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_15477 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_15477(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_15484 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_15484(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_15485 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_15485(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_15488 = (function (b,itm){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_15488(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_15489 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_15489(b);
}
});
