...
while(true){
if((i__5727__auto___13340 < len__5726__auto___13333)){
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq13267){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13268,G__13269,seq13267__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__13292_SHARP_){
return (!((cljs.core.meta(p1__13292_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13303__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e13308){var _e__11901__auto__ = e13308;
return false;
}})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
...
}catch (e13313){var _e__11901__auto__ = e13313;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__13321 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__13322 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__13322);

try{var map__13323 = opts;
var map__13323__$1 = cljs.core.__destructure_map(map__13323);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13323__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__13321);
}});
...
var temp__5802__auto___13384 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___13384)){
var managed_print_level_13385 = temp__5802__auto___13384;
var _STAR_print_level_STAR__orig_val__13325_13386 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__13326_13387 = managed_print_level_13385;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__13326_13387);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__13324_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__13324_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__13325_13386);
}} else {
job_fn();
}
