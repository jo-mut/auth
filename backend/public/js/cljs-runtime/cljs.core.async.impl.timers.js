...
var i_18378 = (0);
while(true){
if((i_18378 < arr.length)){
(arr[i_18378] = null);

var G__18379 = (i_18378 + (1));
i_18378 = G__18379;
continue;
} else {
}
...
var i_18386 = (self__.level + (1));
while(true){
if((i_18386 <= (new_level + (1)))){
(update[i_18386] = self__.header);

var G__18387 = (i_18386 + (1));
i_18386 = G__18387;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_18388 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_18388[i]));
} else {
x__$2.forward.push((((i < links_18388.length))?(links_18388[i]):null));
}

if((i < links_18388.length)){
(links_18388[i] = x__$2);
} else {
links_18388.push(x__$2);
}
...
var i_18391 = (0);
while(true){
if((i_18391 <= self__.level)){
var links_18392 = (update[i_18391]).forward;
if((x__$1 === (((i_18391 < links_18392.length))?(links_18392[i_18391]):null))){
(links_18392[i_18391] = (x__$1.forward[i_18391]));

var G__18393 = (i_18391 + (1));
i_18391 = G__18393;
continue;
} else {
var G__18394 = (i_18391 + (1));
i_18391 = G__18394;
continue;
}
} else {
...
var G__18399 = nx;
var G__18400 = (level__$1 - (1));
x = G__18399;
level__$1 = G__18400;
continue;
} else {
var G__18401 = x;
var G__18402 = (level__$1 - (1));
x = G__18401;
level__$1 = G__18402;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__18407 = nx;
var G__18408 = (level__$1 - (1));
x = G__18407;
level__$1 = G__18408;
continue;
} else {
var G__18409 = x;
var G__18410 = (level__$1 - (1));
x = G__18409;
level__$1 = G__18410;
continue;
}
