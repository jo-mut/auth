...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_15225 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_15225(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_15237 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_15237(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_15245 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_15245(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_15254 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_15254(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_15255 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_15255(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_15256 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_15256(reader);
}
});
...
var G__15361 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__15362 = s.append(c);
c = G__15361;
s = G__15362;
continue;
}
