...
var G__13583 = devtools.prefs.pref(v);
v = G__13583;
continue;
} else {
return v;
...
}catch (e13515){var _e__11921__auto__ = e13515;
return false;
}})();
...
}catch (e13517){var _e__11921__auto__ = e13517;
return false;
}})();
...
}catch (e13523){var _e__11921__auto__ = e13523;
return false;
}}
}
});
...
var vec__13540 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13540,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13540,(1),null);
...
return cljs.core.some((function (p1__13551_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__13551_SHARP_);
}),template);
});
