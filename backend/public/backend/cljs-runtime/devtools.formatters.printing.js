...
var len__5726__auto___13730 = arguments.length;
var i__5727__auto___13731 = (0);
while(true){
if((i__5727__auto___13731 < len__5726__auto___13730)){
args__5732__auto__.push((arguments[i__5727__auto___13731]));

var G__13732 = (i__5727__auto___13731 + (1));
i__5727__auto___13731 = G__13732;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq13633){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13634,G__13635,seq13633__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__13664_SHARP_){
return (!((cljs.core.meta(p1__13664_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13691__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e13692){var _e__11921__auto__ = e13692;
return false;
}})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
...
}catch (e13698){var _e__11921__auto__ = e13698;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__13704 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__13705 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__13705);

try{var map__13710 = opts;
var map__13710__$1 = cljs.core.__destructure_map(map__13710);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13710__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__13704);
}});
...
var temp__5802__auto___13783 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___13783)){
var managed_print_level_13784 = temp__5802__auto___13783;
var _STAR_print_level_STAR__orig_val__13719_13785 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__13720_13786 = managed_print_level_13784;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__13720_13786);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__13714_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__13714_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__13719_13785);
}} else {
job_fn();
}
