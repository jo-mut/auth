...
var o12188 = temp__5802__auto__;
var temp__5802__auto____$1 = (o12188["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o12189 = temp__5802__auto____$1;
return (o12189["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__11606__auto__ = f;
return (o__11606__auto__["toString"]).call(o__11606__auto__);
} else {
return "";
}
}catch (e12204){var _ = e12204;
return "";
}});
...
try{var o__11606__auto___12662 = t;
(o__11606__auto___12662["cljs$lang$ctorPrWriter"]).call(o__11606__auto___12662,t,writer);
}catch (e12217){var __12664 = e12217;
}
...
var char_code = (function (){var o__11606__auto__ = (new String(char$));
return (o__11606__auto__["charCodeAt"]).call(o__11606__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__11606__auto__ = String;
return (o__11606__auto__["fromCharCode"]).call(o__11606__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12266 = num_code;
switch (G__12266) {
case (1):
return (185);
...
var o__11606__auto__ = String;
return (o__11606__auto__["fromCharCode"]).call(o__11606__auto__,superscript_code);
});
/**
...
}catch (e12319){var _e__11618__auto__ = e12319;
return false;
}})())){
...
var vec__12328 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12328,(0),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var o12358 = temp__5802__auto__;
var temp__5802__auto____$1 = (o12358["dependencies_"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o12359 = temp__5802__auto____$1;
return (o12359["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12368){
var vec__12369 = p__12368;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12369,(0),null);
...
var G__12741 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__12742 = cljs.core.butlast(remaining_tokens);
name_tokens = G__12741;
remaining_tokens = G__12742;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12366){
var G__12367 = cljs.core.first(seq12366);
var seq12366__$1 = cljs.core.next(seq12366);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12367,seq12366__$1);
}));
...
var vec__12380 = cljs.core.split_with((function (p1__12378_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12378_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12380,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12380,(1),null);
...
var vec__12396 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12396,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12396,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__12763 = cljs.core.rest(remaining_tokens);
var G__12764 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__12763;
name_tokens = G__12764;
continue;
} else {
...
var vec__12406 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12406,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12406,(1),null);
var vec__12409 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12409,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12409,(1),null);
var vec__12412 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12412,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12412,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12412,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12412,(3),null);
...
var vec__12422 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12422,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12422,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12422,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12422,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12422,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12422,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__12435 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12435,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12435,(1),null);
var vec__12439 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12439,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12439,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__12452 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__12452) : devtools.munging.parse_fn_info_deep.call(null, G__12452));
})()));
}
} else {
return fn_info;
...
var G__12822 = (arity + (1));
var G__12823 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12479){
var vec__12480 = p__12479;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12480,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12480,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12503_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__12503_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12504_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__12504_SHARP_);
}),sorted_infos);
...
var G__12836 = (i__5727__auto___12835 + (1));
i__5727__auto___12835 = G__12836;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12522){
var vec__12527 = p__12522;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12527,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12514){
var G__12515 = cljs.core.first(seq12514);
var seq12514__$1 = cljs.core.next(seq12514);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12515,seq12514__$1);
}));
...
var map__12563 = options;
var map__12563__$1 = cljs.core.__destructure_map(map__12563);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12563__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12563__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12563__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12563__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12564 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12564,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12564,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12564,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12564,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12564,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12564,(5),null);
...
var o__11606__auto__ = f;
return (o__11606__auto__["getBasis"]).call(o__11606__auto__);
});
/**
...
}catch (e12576){var _e__11618__auto__ = e12576;
...
var G__12838 = (obj[cljs.core.first(path)]);
var G__12839 = cljs.core.rest(path);
obj = G__12838;
path = G__12839;
continue;
} else {
...
var _STAR_ = (function (accum,p__12608){
var vec__12609 = p__12608;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12609,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12609,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12614){
var vec__12616 = p__12614;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12616,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12616,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12616,(2),null);
...
var post_process = (function (p__12631){
var vec__12632 = p__12631;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12632,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12632,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12620_SHARP_){
return (obj[cljs.core.first(p1__12620_SHARP_)]);
}),sorted_matches);
