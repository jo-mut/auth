...
var o12424 = temp__5802__auto__;
var temp__5802__auto____$1 = (o12424["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o12425 = temp__5802__auto____$1;
return (o12425["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__11916__auto__ = f;
return (o__11916__auto__["toString"]).call(o__11916__auto__);
} else {
return "";
}
}catch (e12433){var _ = e12433;
return "";
}});
...
try{var o__11916__auto___12778 = t;
(o__11916__auto___12778["cljs$lang$ctorPrWriter"]).call(o__11916__auto___12778,t,writer);
}catch (e12444){var __12779 = e12444;
}
...
var char_code = (function (){var o__11916__auto__ = (new String(char$));
return (o__11916__auto__["charCodeAt"]).call(o__11916__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__11916__auto__ = String;
return (o__11916__auto__["fromCharCode"]).call(o__11916__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12459 = num_code;
switch (G__12459) {
case (1):
return (185);
...
var o__11916__auto__ = String;
return (o__11916__auto__["fromCharCode"]).call(o__11916__auto__,superscript_code);
});
/**
...
}catch (e12476){var _e__11955__auto__ = e12476;
return false;
}})())){
...
var vec__12478 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12478,(0),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var o12500 = temp__5802__auto__;
var temp__5802__auto____$1 = (o12500["dependencies_"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o12501 = temp__5802__auto____$1;
return (o12501["nameToPath"]);
} else {
return null;
}
} else {
...
while(true){
if((i__5727__auto___12836 < len__5726__auto___12834)){
...
var G__12845 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__12846 = cljs.core.butlast(remaining_tokens);
name_tokens = G__12845;
remaining_tokens = G__12846;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12509){
...
var vec__12534 = cljs.core.split_with((function (p1__12531_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12531_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12534,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12534,(1),null);
...
var vec__12546 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12546,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12546,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__12852 = cljs.core.rest(remaining_tokens);
var G__12853 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__12852;
name_tokens = G__12853;
continue;
} else {
...
var vec__12553 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12553,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12553,(1),null);
var vec__12556 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12556,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12556,(1),null);
var vec__12559 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12559,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12559,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12559,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12559,(3),null);
...
var vec__12573 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12573,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12573,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12573,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12573,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12573,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12573,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__12582 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12582,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12582,(1),null);
var vec__12588 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12588,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12588,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__12602 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__12602) : devtools.munging.parse_fn_info_deep.call(null, G__12602));
})()));
}
} else {
return fn_info;
...
var G__12908 = (arity + (1));
var G__12909 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12619){
var vec__12621 = p__12619;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12621,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12621,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12628_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__12628_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12629_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__12629_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12638){
var vec__12639 = p__12638;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12639,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12633){
var G__12634 = cljs.core.first(seq12633);
var seq12633__$1 = cljs.core.next(seq12633);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12634,seq12633__$1);
}));
...
var G__12650 = arg;
var G__12650__$1 = (((G__12650 instanceof cljs.core.Keyword))?G__12650.fqn:null);
switch (G__12650__$1) {
...
var map__12673 = options;
var map__12673__$1 = cljs.core.__destructure_map(map__12673);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12673__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12673__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12673__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12673__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12674 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12674,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12674,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12674,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12674,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12674,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12674,(5),null);
...
var o__11916__auto__ = f;
return (o__11916__auto__["getBasis"]).call(o__11916__auto__);
});
/**
...
}catch (e12687){var _e__11955__auto__ = e12687;
...
var G__12967 = (obj[cljs.core.first(path)]);
var G__12968 = cljs.core.rest(path);
obj = G__12967;
path = G__12968;
continue;
} else {
...
var _STAR_ = (function (accum,p__12720){
var vec__12721 = p__12720;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12721,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12721,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12733){
var vec__12735 = p__12733;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12735,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12735,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12735,(2),null);
...
var vec__12757 = p__12754;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12757,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12757,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12749_SHARP_){
return (obj[cljs.core.first(p1__12749_SHARP_)]);
}),sorted_matches);
