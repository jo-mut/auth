...
var G__13519 = devtools.prefs.pref(v);
v = G__13519;
continue;
} else {
return v;
...
}catch (e13402){var _e__11955__auto__ = e13402;
return false;
}})();
...
}catch (e13414){var _e__11955__auto__ = e13414;
return false;
}})();
...
}catch (e13428){var _e__11955__auto__ = e13428;
return false;
}}
}
});
...
var vec__13454 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13454,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13454,(1),null);
...
return cljs.core.some((function (p1__13467_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__13467_SHARP_);
}),template);
});
