...
var G__13210 = devtools.prefs.pref(v);
v = G__13210;
continue;
} else {
return v;
...
}catch (e13158){var _e__11618__auto__ = e13158;
return false;
}})();
...
}catch (e13161){var _e__11618__auto__ = e13161;
return false;
}})();
...
}catch (e13163){var _e__11618__auto__ = e13163;
return false;
}}
}
});
...
var vec__13176 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13176,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13176,(1),null);
...
return cljs.core.some((function (p1__13186_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__13186_SHARP_);
}),template);
});
