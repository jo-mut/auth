...
var G__13696 = (i__5727__auto___13694 + (1));
i__5727__auto___13694 = G__13696;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq13560){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13561,G__13562,seq13560__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__13584_SHARP_){
return (!((cljs.core.meta(p1__13584_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13594__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e13598){var _e__11955__auto__ = e13598;
return false;
}})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
...
}catch (e13600){var _e__11955__auto__ = e13600;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__13663 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__13664 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__13664);

try{var map__13665 = opts;
var map__13665__$1 = cljs.core.__destructure_map(map__13665);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13665__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__13663);
}});
...
var temp__5802__auto___13739 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___13739)){
var managed_print_level_13740 = temp__5802__auto___13739;
var _STAR_print_level_STAR__orig_val__13679_13741 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__13680_13742 = managed_print_level_13740;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__13680_13742);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__13673_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__13673_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__13679_13741);
}} else {
job_fn();
}
