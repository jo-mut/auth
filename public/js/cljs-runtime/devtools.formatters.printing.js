...
var len__5726__auto___13323 = arguments.length;
var i__5727__auto___13324 = (0);
while(true){
if((i__5727__auto___13324 < len__5726__auto___13323)){
args__5732__auto__.push((arguments[i__5727__auto___13324]));

var G__13325 = (i__5727__auto___13324 + (1));
i__5727__auto___13324 = G__13325;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq13230){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13231,G__13232,seq13230__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__13258_SHARP_){
return (!((cljs.core.meta(p1__13258_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13278__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e13280){var _e__11618__auto__ = e13280;
return false;
}})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
...
}catch (e13282){var _e__11618__auto__ = e13282;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__13290 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__13291 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__13291);

try{var map__13294 = opts;
var map__13294__$1 = cljs.core.__destructure_map(map__13294);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13294__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__13290);
}});
...
var temp__5802__auto___13356 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___13356)){
var managed_print_level_13357 = temp__5802__auto___13356;
var _STAR_print_level_STAR__orig_val__13307_13358 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__13308_13359 = managed_print_level_13357;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__13308_13359);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__13299_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__13299_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__13307_13358);
}} else {
job_fn();
}
