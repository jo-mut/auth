...
backend.server.app.use(shadow.js.shim.module$express.static(shadow.js.shim.module$path.join(backend.server.dirname,"/public")));

backend.server.app.use(shadow.js.shim.module$express.static(shadow.js.shim.module$path.join(backend.server.dirname,"/frontend/dist")));

backend.server.app.get("*",(function (req,res){
return res.sendFile(shadow.js.shim.module$path.resolve(backend.server.dirname,"frontend","dist","index.html"));
}));
} else {
}
