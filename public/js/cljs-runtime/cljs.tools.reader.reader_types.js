...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_14806 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_14806(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_14809 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_14809(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_14818 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_14818(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_14821 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_14821(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_14828 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_14828(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_14833 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_14833(reader);
}
});
...
var G__14921 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__14922 = s.append(c);
c = G__14921;
s = G__14922;
continue;
}
