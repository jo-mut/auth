...
if(cljs.core.not(new cljs.core.Keyword(null,"is-verified","is-verified",-2036107091).cljs$core$IFn$_invoke$arity$1(user))){
return reagent.core.as_element.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$react_router_dom$dist$main.Navigate,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"to","to",192099007),"/verify-email",new cljs.core.Keyword(null,"replace","replace",-786587770),cljs.core.replace], null)], null));
} else {
return children;
