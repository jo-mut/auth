...
frontend.pages.email_verification.handle_verify_email = (function frontend$pages$email_verification$handle_verify_email(){
return null;
});
...
var new_code_14996 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(code,index,value);
(set_code.cljs$core$IFn$_invoke$arity$1 ? set_code.cljs$core$IFn$_invoke$arity$1(new_code_14996) : set_code.call(null, new_code_14996));
...
}),new cljs.core.Keyword(null,"class-name","class-name",945142584),"w-12 h-12 text-center justify-center text-2xl font-bold bg-gray-700 text-white\n                           border-2 border-gray-500 rounded-lg focus:border-green-500 focus:outline-none"], null)], null);
}),code)], null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$framer_motion$dist$cjs$index.motion.button,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"className","className",-1983287057),"mt-5 w-full py-3 px-4 bg-gradient-to-r from-yellow-500 to-emerald-600 text-white \n                    font-bold rounded-lg shadow-lg hover:from-orange-600 hover:to-emerald-700 focus:outline-none\n                    focus:ring-2 focus:ring-orange-500 focus:fing-offset-2 focus:ring-offset-gray-900 transition \n                    duration-200",new cljs.core.Keyword(null,"whileHover","whileHover",-678588413),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"scale","scale",-230427353),1.02], null),new cljs.core.Keyword(null,"whileTop","whileTop",340419246),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"scale","scale",-230427353),0.98], null),new cljs.core.Keyword(null,"disabled","disabled",-1529784218),loading_QMARK_,new cljs.core.Keyword(null,"type","type",1174270348),"submit"], null),"Verify email"], null)], null)], null);
});
