...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_11668 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_11668(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_11670 = (function (port,val,fn1_handler){
var x__5350__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_11670(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_11673 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_11673(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_11675 = (function (chan){
var x__5350__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_11675(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_11681 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_11681(h);
}
});
...
var cljs$core$async$impl$protocols$Handler$commit$dyn_11684 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_11684(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_11691 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_11691(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_11694 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_11694(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_11698 = (function (b,itm){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_11698(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_11709 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_11709(b);
}
});
