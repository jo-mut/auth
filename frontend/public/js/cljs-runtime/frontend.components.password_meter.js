...
return cljs.core.reset_BANG_(strength,cljs.core.inc);
} else {
if(cljs.core.truth_((function (){var and__5000__auto__ = cljs.core.re_matches(/\/a-z\//,password);
if(cljs.core.truth_(and__5000__auto__)){
return cljs.core.re_matches(/\/A-Z\//,password);
} else {
...
if(cljs.core.truth_(cljs.core.re_matches(/\/\d\//,password))){
return cljs.core.reset_BANG_(strength,cljs.core.inc);
} else {
if(cljs.core.truth_(cljs.core.re_matches(/\/^A-Za-z0-9\//,password))){
return cljs.core.reset_BANG_(strength,cljs.core.inc);
} else {
return null;
}
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),item,new cljs.core.Keyword(null,"className","className",-1983287057),["h-1 w-1/4 rounded-full transition-colors\n                                                                duration-300",(((item < frontend.components.password_meter.strength_meter(password)))?frontend.components.password_meter.get_color(frontend.components.password_meter.strength_meter(password)):"bg-gray-600")].join('')], null)], null);
