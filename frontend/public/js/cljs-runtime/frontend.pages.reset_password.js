...
return frontend.api.core.reset_password(new cljs.core.Keyword(null,"token","token",-1211463215).cljs$core$IFn$_invoke$arity$1(params),password).then((function (){
...
var vec__13925 = module$node_modules$react$index.useState("");
var password = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13925,(0),null);
var set_password = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13925,(1),null);
var vec__13928 = module$node_modules$react$index.useState("");
var confirm_password = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13928,(0),null);
var set_confirm_password = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13928,(1),null);
var vec__13931 = module$node_modules$react$index.useState("");
var confirm_password_error = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13931,(0),null);
var set_confirm_password_error = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13931,(1),null);
var map__13934 = cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"get-auth-data","get-auth-data",-1689545573)], null)));
var map__13934__$1 = cljs.core.__destructure_map(map__13934);
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13934__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var loading_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13934__$1,new cljs.core.Keyword(null,"loading?","loading?",1905707049));
...
var G__13936 = e.target.value;
return (set_password.cljs$core$IFn$_invoke$arity$1 ? set_password.cljs$core$IFn$_invoke$arity$1(G__13936) : set_password.call(null, G__13936));
...
var G__13938 = e.target.value;
return (set_confirm_password.cljs$core$IFn$_invoke$arity$1 ? set_confirm_password.cljs$core$IFn$_invoke$arity$1(G__13938) : set_confirm_password.call(null, G__13938));
