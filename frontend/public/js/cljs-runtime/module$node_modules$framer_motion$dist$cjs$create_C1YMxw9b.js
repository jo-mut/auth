shadow$provide.module$node_modules$framer_motion$dist$cjs$create_C1YMxw9b = function(global, require, module, exports) {
  ...
  function getElementIndex(element) {
    return element.parentNode ? Array.from(element.parentNode.children).indexOf(element) : -1;
  }
  ...
  class VisualElement {
    ...
    update(props, presenceContext) {
      ...
      for (const key in props) {
        key$jscomp$0 = props[key], listener = presenceContext[key], key$jscomp$0 && key$jscomp$0.getVelocity ? (this.addValue(key, key$jscomp$0), warnOnce("12.4.10" === key$jscomp$0.version, `Attempting to mix Motion versions ${key$jscomp$0.version} with 12.4.10 may not work as expected.`)) : listener && listener.getVelocity ? this.addValue(key, motionValue(key$jscomp$0, {owner:this})) : listener !== key$jscomp$0 && (this.hasValue(key) ? (listener = this.getValue(key), !0 === listener.liveStyle ? 
        listener.jump(key$jscomp$0) : listener.hasAnimated || listener.set(key$jscomp$0)) : (listener = this.getStaticValue(key), this.addValue(key, motionValue(void 0 !== listener ? listener : key$jscomp$0, {owner:this}))));
      }
    ...
    constructor(event, handlers, {transformPagePoint, dragSnapToOrigin = !1} = {}) {
      ...
      if (motionDom.isPrimaryPointer(event)) {
        ...
        this.removeListeners = [addPointerEvent(event.currentTarget, "pointermove", this.handlePointerMove), addPointerEvent(event.currentTarget, "pointerup", this.handlePointerUp), addPointerEvent(event.currentTarget, "pointercancel", this.handlePointerUp), addPointerEvent(event.currentTarget, "lostpointercapture", (lostPointerEvent, lostPointerInfo) => {
          getElementIndex(lostPointerEvent.currentTarget) !== this.index ? motionDom.capturePointer(lostPointerEvent, "set") : this.handlePointerUp(lostPointerEvent, lostPointerInfo);
        })].reduce(combineFunctions);
      }
    }
  ...
  class MeasureLayoutWithContext extends React.Component {
    ...
    getSnapshotBeforeUpdate(prevProps) {
      ...
      drag || prevProps.layoutDependency !== layoutDependency || void 0 === layoutDependency || prevProps.isPresent !== isPresent ? projection.willUpdate() : this.safeToRemove();
...
//# sourceMappingURL=module$node_modules$framer_motion$dist$cjs$create_C1YMxw9b.js.map
